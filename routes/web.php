...
Route::middleware('checkUserExist')->group(function () {
    ...
    Route::post('event_photo/Bulk_deletePost', [EventPhotoController::class, 'Bulk_deletePost']);
    ...
    Route::post('event_wall/postMediaReport', [EventWallController::class, 'postMediaReport'])->name('event_wall.postMediaReport');
    ...
    Route::post('event_wall/updatePost', [EventWallController::class, 'updatePost'])->name('event_wall.updatePost');
    Route::post('event_wall/fetchPostWall', [EventWallController::class, 'fetchPostWall'])->name('event_wall.fetchPostWall');
