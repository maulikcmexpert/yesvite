...

{
    ...
    public function createEvent(Request $request)
    {
        ...
        $staticInformation = (isset($eventData['static_information']) && $eventData['static_information'] != '') ? json_encode($eventData['static_information']) : null;
    ...
    public function getEventData(Request $request)
    {
        ...
        try {
            ...
            if ($getEventData != null) {
                ...
                $eventDetail['static_information'] = ($getEventData->static_information != NULL) ? json_decode($getEventData->static_information) : "";
