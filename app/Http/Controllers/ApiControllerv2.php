...

{
    ...
    public function getEventData(Request $request)
    {
        ...
        try {
            ...
            if ($getEventData != null) {
                ...
                $eventDetail['hosted_id'] = (!empty($getEventData->user_id) && $getEventData->user_id != NULL) ? $getEventData->user_id : "";
    ...
    public function eventPostDetail(Request $request)
    {
        ...
        if ($eventDetails != null) {
            ...
            $isCoHost =  EventInvitedUser::where(['event_id' => $eventDetails->event_id, 'user_id' => $user->id])->first();
