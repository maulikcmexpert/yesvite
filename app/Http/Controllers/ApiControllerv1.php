...

{
    ...
    public function createEvent(Request $request)
    {
        ...
        if ($eventCreation) {
            ...
            // dd($eventData);
            $eventCreation->event_type =(isset($eventData['event_type']) && $eventData['event_type']!="")?$eventData['event_type']: "";
    ...
    public function editEvent(Request $request)
    {
        ...
        try {
            ...
            if ($updateEvent != null) {
                ...
                $updateEvent->event_type = (isset($eventData['event_type'])&& $eventData['event_type']!="") ? $eventData['event_type'] : '1';
                ...
                if (isset($eventData['invited_new_guest']) && count($eventData['invited_new_guest']) != 0) {
                    ...
                    if(isset($eventData['event_type'])&& $eventData['event_type']=="1"){
        ...
        try {
            ...
            if ($request->is_update_event == '0') {
                if ($checkUserInvited->event_invited_user_count != '0' && $checkUserInvited->is_draft_save == '0') {
                    ...
                    if($checkUserInvited->event_type=="1"){
...

    {
        ...
        try {
            ...
            $eventAboutHost['event_type'] = (isset($eventDetail->event_type) && $eventDetail->event_type != NULL) ? $eventDetail->event_type : "";
    ...
    public function sendInvitation(Request $request)
    {
        ...
        if (!empty($input['guest_list'])) {
            ...
            $getType= Event::where('id',$input['event_id'])->select('event_type')->first();
            if($getType->event_type=='1'){
