        ...
        try {
            ...
            if (!empty($user)) {
                ...
                $profileData = [
                    ...
                    'pending_rsvp_count' => ($this->pendingRsvpCount['total_need_rsvp_event_count']!="")?$this->pendingRsvpCount['total_need_rsvp_event_count']:"",
                    'Pending_rsvp_event_id' => ($this->pendingRsvpCount['PendingRsvpEventId']!="")?$this->pendingRsvpCount['PendingRsvpEventId']:"",
