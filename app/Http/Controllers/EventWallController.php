...
class EventWallController extends BaseController
{
    ...
    public function index(String $id)
    {
        ...
        $eventDetail = Event::with([
            ...
            'event_schedule',
            'event_settings' => function ($query) {
                $query->select('event_id', 'podluck', 'allow_limit', 'adult_only_party', 'event_wall', 'guest_list_visible_to_guests','photos');
            },
        ...
        $eventDetails['rsvp_by'] = (!empty($eventDetail->rsvp_by_date) || $eventDetail->rsvp_by_date != NULL) ? $eventDetail->rsvp_by_date : "";
