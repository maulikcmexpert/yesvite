...
`;
  ...
  if (icon.hasClass("fa-bell")) {
    const svgWrapper = $(this).closest(".upcoming-events-card-notification-wrp").find("svg");
  ...
  $.ajax({
    ...
    type: 'POST',
    data: { is_owner:is_owner,user_id:user_id,status:status,event_id: event_id, _token: $('meta[name="csrf-token"]').attr("content")},
