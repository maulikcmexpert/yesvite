...
async function bindData(current_event_id) {
    ...
    canvas = new fabric.Canvas("imageEditor1", {
        width: 590, // Canvas width
        height: 880, // Canvas height
    });
