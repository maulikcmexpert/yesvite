...
$(document).on("click", ".self_bring_quantity", function () {
    ...
    if (type == "plus") {
        // if (main_quantity > self_quantity) {
            ...
            if (main_quantity > self_quantity) {
                // var item_qty= parseInt($('#item_quantity').val());
...
$(document).on("click", ".final_checkout", function () {
    ...
    if (eventData.slider_images != undefined && eventData.slider_images != "") {
        ...
        photoSliders.forEach((sliderClass, index) => {
            ...
            //         sliderElement.attr(
            //             "src",
            //             `${base_url}storage/event_images/${sliderImages[index].fileName}`
            //         );
            ...
            if (sliderImages[index]) {
                const slideHtml = `
                    <div class="item">
                        <div class="setting-img">
                            <img src="${base_url}storage/event_images/${sliderImages[index].fileName}" />
                        </div>
                    </div>
                `;
...
var imageSources = [];
var imagenames = [];
$(document).on("change", ".slider_photo", async function (event) {
