...
export function initializeAudioPlayer(player) {
    ...
    function loadSong(songUrl) {
        ...
        isDurationLoaded = false; // Reset the flag when a new song is loaded
    }
    ...
    function updateProgress() {
        if (audioPlayer.duration) {
            ...
            if (isDurationLoaded) {
                durationDisplay.textContent = " - " + displayTime(audioPlayer.duration);
            }
        }
    }
    ...
    if (audioPlayer.readyState > 0) {
        ...
        // Add an event listener for 'durationchange' as well, in case 'loadedmetadata' fires too early
        audioPlayer.addEventListener("durationchange", displayDuration);
    }
    ...
    function handleRangeUpdate() {
        ...
        speakerIcon.className =
            audioPlayer.volume === 0 ? "fa fa-volume-off" : "fa fa-volume-up";
    }
