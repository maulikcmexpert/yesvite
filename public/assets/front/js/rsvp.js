...
$(document).ready(function () {
    ...
    document
        ...
        .addEventListener("click", function () {
            ...
            const eventTime = $("#eventTime").val();  // Get the event start time
            const eventEndTime =
                $("#eventEndTime").val() || $("#eventTime").val();  // Get the event end time, default to start time
            const eventName = $("#eventName").val();  // Get the event name
            ...
            &startdt=${encodeURIComponent(eventDate)}T${encodeURIComponent(formattedTime)}:00
            &enddt=${encodeURIComponent(eventEndDate)}T${encodeURIComponent(formattedEndTime)}:00
