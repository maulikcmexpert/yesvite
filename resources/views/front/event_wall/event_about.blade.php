                                        ...
                                        <div class="birth-details">
                                            ...
                                            <div class="countdown-event">
                                                ...
                                                @php
                                                    ...
                                                    $months = $now->diffInMonths($eventDateTime, false); // Negative if past the event
                                                    $days = $now
                                                        ->copy()
                                                        ->addMonths($months)
                                                        ->diffInDays($eventDateTime, false);
                                                    $hours = $now
                                                        ->copy()
                                                        ->addMonths($months)
                                                        ->addDays($days)
                                                ...
                                                <div class="countevent-counter-box">
                                                    @if ($months >= 0 && $days >= 0 && $hours >= 0)
                                                        <div class="countevent-counter">
                                                            <h4>{{ str_pad($months, 2, '0', STR_PAD_LEFT) }}</h4>
                                                            <span>Months</span>
                                                        ...
                                                        <div class="countevent-counter">
                                                            <h4>{{ str_pad($hours, 2, '0', STR_PAD_LEFT) }}</h4>
                                                            <span>Hours</span>
                                                        </div>
                                                    @endif
                                                </div>
                                    ...
                                    @if (!empty($eventDetails['event_schedule']) && is_array($eventDetails['event_schedule']))
                                        @foreach ($eventDetails['event_schedule'] as $schedule)
                                            @php
                                                ...
                                                if (is_null($overallEndTime) || $scheduleEndTime > $overallEndTime) {
