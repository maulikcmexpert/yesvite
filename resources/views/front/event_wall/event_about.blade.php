                                            ...
                                            <div class="host-user-con-box">
                                                @if ($eventDetails['hosted_by'])
                                                    <div class="host-user-con">
                                                        ...
                                                        <span>Host</span>
                                                        <a href="{{route('message.list',encrypt($eventDetails['host_id'],1 ))}}" class="msg-btn">Message</a>
                                                    </div>
                                                @endif
                                                @if (!empty($eventDetails['co_hosts']))
                                                    @foreach ($eventDetails['co_hosts'] as $co_host)
                                                        <div class="host-user-con">
                                                            ...
                                                            <h5>{{ $co_host['name'] }}</h5>
                                                            <span>Co-host</span>
                                                            <a href="{{route('message.list',encrypt($co_host['id'],0))}}" class="msg-btn">Message</a>
                                                        </div>
                                                    @endforeach
                                                @endif
