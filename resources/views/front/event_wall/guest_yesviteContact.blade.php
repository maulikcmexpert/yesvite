        ...
        <div class="w-100">
            <div class="d-flex justify-content-between align-items-center">
                <a href="#" class="invite-user-name" data-bs-toggle="modal"
                    data-bs-target="#editguest">      {{ $contact->firstname }} {{ $contact->lastname }}</a>
            </div>
            <div class="d-flex align-items-center mt-1">
                ...
                <div class="ms-auto">
                    <input class="form-check-input failed-checkout contact-checkbox" type="checkbox"
            ...
            <div class="invite-call-data mt-1">
                ...
                <input class="form-check-input failed-checkout contact-checkbox" type="checkbox"
                data-id="{{ $contact->id }}"  data-name="{{  $contact->firstname }}" data-last="{{$contact->lastname }}"
                    data-email="{{ $contact->email }}"
                    data-phone="{{ $contact->phone_number }}">
            </div>
        </div>
