...
@if (!empty($invite))
    @foreach ($invite as $guest)
        ...
        @endphp
        <li class="guests-listing-info contact contactslist" data-guest-id="{{ $guest['guest_id'] }}"
            ...
            <div class="d-flex align-items-center justify-content-between w-100 gap-2">
                <div class="posts-card-head-left guests-listing-left">
                    ...
                    <div class="posts-card-head-left-content contact_search"
                        ...
                        @if ($guest['is_sync'] == '0')
                            <h3 class="openProfileModal" data-bs-toggle="modal" data-bs-target="#wall_profile"
