                                                    ...
                                                    <div class="posts-card-wrp guest-user-list">
                                                        <div class="posts-card-head">
                                                            <div class="posts-card-head-left">
                                                                <div class="posts-card-head-left-img guest-users"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        ...
                                                                        @if ($post['user_id'] != $login_user_id)
                                                                            ...
                                                                            <li>
                                                                                <button class="dropdown-item reportbtn"
                                                                                    href="#"
                                                                                    data-event-id="{{ $event }}"
                                                                                    data-event-post-id="{{ $post['id'] }}"
                                                                                    data-user-id="{{ $login_user_id }}"
                                                                        ...
                                                                        @if ($post['user_id'] == $login_user_id)
                                                                            <li>
                                                                                <button
                                                                                    ...
                                                                                    data-user-id="{{ $login_user_id }}"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#creatpostmodal"
                                                                                    data-post-content="{{ $post['post_message'] }}"
                                                                                    data-post-type="{{ $post['post_type'] }}"
                                                                                    data-is-in-photo-moudle="{{ $post['is_in_photo_moudle'] }}"
                                                                                    data-post-privacy="{{ $post['post_privacy'] }}"
                                                                                    data-comment-on-off="{{ $post['commenting_on_off'] }}"
                                                                                ...
                                                                                <button
                                                                                    ...
                                                                                    <svg width="16" height="16"
                                                                                        ...
                                                                                        <path
                                                                                            ...
                                                                                            stroke-linejoin="round" />
                                                                                        <path
                                                                                            d="M5.66406 3.31301L5.81073 2.43967C5.9174 1.80634 5.9974 1.33301 7.12406 1.33301H8.87073C9.9974 1.33301 10.0841 1.83301 10.1841 2.44634L10.3307 3.31301"
                                                                                            stroke="#F73C71"
                                                                                            stroke-width="1.5"
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round" />
                                                                                        <path
                                                                                            ...
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round" />
                                                                                        <path d="M6.88281 11H9.10281"
                                                                                            stroke="#F73C71"
                                                                                            stroke-width="1.5"
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round" />
                                                                                        <path
                                                                                            d="M6.33594 8.33301H9.66927"
                                                                                            stroke="#F73C71"
                                                                                            stroke-width="1.5"
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round" />
                                                        ...
                                                        @php
                                                            $postMedia = [];
                                                            foreach ($post['post_image'] as $media) {
                                                        ...
                                                        {{-- {{  dd( $postMedia )}} --}}
                                                        @if ($post['post_type'] == '1')
                                                            <div class="posts-card-show-post-wrp open_photo_model"
                                                                data-image-src='@json($postMedia)'
                                                            ...
                                                            @if ($post['rsvp_status'] == '1')
                                                                ...
                                                                <div class="sucess-yes">
                                                                    ...
                                                                    <div class="sucesss-cat ms-auto">
                                                                        ...
                                                                        <h5>
                                                                            {{ $post['adults'] }}
                                                                            <span>{{ $post['adults'] == '1' ? 'Adult' : 'Adults' }}</span>
                                                                        </h5>
                                                                        <h5>
                                                                            {{ $post['kids'] }}
                                                                            <span>{{ $post['kids'] == '1' ? 'Kid' : 'Kids' }}</span>
                                                                        </h5>
                                                                    </div>
                                                                </div>
                                                            @else
                                                        ...
                                                        <div class="posts-card-like-commnet-wrp photo-card-head-right">
                                                            <div class="posts-card-like-comment-left post_model">
                                                                ...
                                                                @if ($post['commenting_on_off'] == '1')
                                                                    <button id="comment_{{ $post['id'] }}"
                                                                        class="posts-card-comm show-comments-btn show-btn-comment comment_btn comment_{{ $post['id'] }}"
                                                                        event_p_id="{{ $post['id'] }}">
                        ...
                        <div class="create-post-poll-wrp d-none">
                            ...
                            <div class="create-post-poll-inner">
                                <form id="pollForm" action="{{ route('event_wall.createPoll') }}" method="POST">
                                    ...
                                    <input type="hidden" name="event_id" id="event_id"
                                        value="{{ $event }}">
                                    <input type="hidden" name="post_id" id="postId" class="poll_post_id"
                                        value="">
                                    <input type="hidden" class="hiddenVisibility" name="post_privacys"
                                        value="1">
                                    <input type="hidden" class="hiddenAllowComments" name="commenting_on_off"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="question" class="form-control poll_qus"
                                            id="yourquestion" placeholder="How is everyone doing this evening?"
                                            required>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="submit-blocks">
                    ...
                    <span class="report-option" data-report-type="Inappropriate Content">Inappropriate
                        Content</span>
                    <span class="report-option" data-report-type="Violating Platform Policies">Violating Platform
                        Policies</span>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-secondary btn-submit-report" data-bs-dismiss="modal">Submit
                    Report</button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
                    ...
                    <div class="posts-card-wrp">
                        ...
                        <div class="posts-card-like-commnet-wrp">
                            <div class="posts-card-like-comment-left_reaction">
                                ...
                                <button id="comments" class="posts-card-comm show-comments-btn comments_wall_count">354
                                    Comments
                                    </buttton>
                            </div>
            ...
            <div class="modal-footer">
                <div class="posts-card-main-comment all-comments-textbox">
                    <input type="text" class="form-control post_comment" id="post_comment_wall" placeholder="Add Comment">
                    <span class="comment-send-icon send_comment send_comment_wall">
                    ...
                    <span class="comment-microphone-icon">
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M10.6094 6.43C11.5094 6.1 12.4894 6.1 13.3894 6.43" stroke="#94A3B8"
                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M11.1992 8.55001C11.7292 8.41001 12.2792 8.41001 12.8092 8.55001"
                                stroke="#94A3B8" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
