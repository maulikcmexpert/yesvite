            ...
            <div class="modal-content">
                ...
                <div class="modal-footer rsvp-button-wrp">
                    <button type="button" class="btn btn-secondary remove-btn remove_guest_page"
                        ...
                        Guest</button>
                    <button type="button" class="btn btn-secondary save-btn guest-rsvp-edit-btn" >Update</button>
                        ...
                        <div class="invite-contact">
                            ...
                            <div class="w-100">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-1">
                                    ...
                                    id="coming"> -->
                                    @else
                                    <input class="form-check-input failed-checkout failed_check_resend_email" data-prefer="email" data-id="{{ $invite['id']}}" data-app_user="{{$invite['app_user']}}" type="checkbox" value=""
                                        id="coming">
                                        @endif
                                </div>
                                @endif
