                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade {{ $photos_show }} {{ $photos_active }}" id="nav-photos"
                                ...
                                <div class="photos-main-wrp">
                                                            ...
                                                            <div class="photos-card-dropdown dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    <li><button class="dropdown-item bulk_select" id="bulk_select"
                                                                        data-event-post-id="{{ $photo['id'] }}"
                                                                        data-event-id="{{ $event }}">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 52 52" fill="none" stroke="black" stroke-width="1.5">
                                    ...
                                    <div class="phototab-add-new-photos-wrp bulk-select-photo-wrp select_bulk_btn d-none">
                                        <div class="phototab-add-new-photos-img bulk_delete_selected" >
                                            <i class="fa-solid fa-angle-left"></i>
                                            <p>3 Photos Selected</p>
                                        </div>
                                        <div class="phototab-add-new-btns-section">
                                            ...
                                            <button class="add-new-photos-btn cmn-btn bulk_delete d-none" type="button" style="height: 42.38px">
                                                Delete</button>
                                        </div>
                                    </div>
                                    {{-- @endif --}}
                ...
                <div class="event-posts-main-wrp common-div-wrp">
                    <div class="posts-card-wrp">
                        ...
                        <div class="posts-card-like-commnet-wrp">
                            <div class="posts-card-like-comment-left_reaction">
