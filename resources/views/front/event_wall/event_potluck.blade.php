    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="qantity-total">
                ...
                <div class="qty-container ms-auto">
                    <button class="qty-btn-minus" class="itemTotalQnt" type="button"><i class="fa fa-minus"></i></button>
                    <input type="number" id="sub_quantity" name="sub_quantity" value="0" class="input-qty" />
                    <button class="qty-btn-plus" class="itemTotalQnt" type="button"><i class="fa fa-plus"></i></button>
                </div>
            </div>
        </div>
        <div class="modal-footer">
