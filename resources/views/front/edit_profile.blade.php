...
<style>
    ...
    #profileIm {
        ...
        max-width: none;
        /* Allow the image to exceed its container's bounds for zooming */
        cursor: grab;
    }
</style>
                        ...
                        <div class="profile-content login-form-wrap">
                            <form method="POST" action="{{route('profile.update',encrypt($user->id))}}" id="updateUserForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="input-form">
                                            <input type="text" class="phone_number border-0" id="country_code" name="countryCode" readonly>
                                            <input type="text" class="form-control phone_number" id="phone_number" name="phone_number" value="{{ $user->phone_number}}"oninput="this.value = this.value.replace(/[^0-9]/g, '');">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="cover-img" id="bg-cover-img">
                    <img src="{{$user->bg_profile}}" alt="bg-cover-img" id="bgIm">
                </div>
                <div>
                    <div class="slidecontainer">
                        <h5>Zoom</h5>
