            ...
            @csrf
                    ...
                    <div class="uploadedcvs-file-wrp">
                        <div class="uploadedcvs-file-card home-latest-draf-card uploading_csv_file">
                            ...
                            <div class="uploadedcvs-file-card-content">
                                <h4 class="contact_file_name">contact.csv</h4>
                                <div class="uploadedcvs-file-icon-text">

                                <p class="file_upload_rate">0 KB of 0 KB </p>
                                <span>
                            ...
                            <button class="cancel-uploading-btn" type="button"><svg viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="uploadedcvs-file-card home-latest-draf-card uploading_csv_complete">
                            ...
                            <div class="uploadedcvs-file-card-content">
                                <h4 class="contact_file_name">contact.csv</h4>
                                <div class="uploadedcvs-file-icon-text">
                                {{-- <p class="file_upload_rate">60 KB of 120 KB </p> --}}
                                <span>
                            ...
                            <button class="delete-uploading-btn" type="button"><svg viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="modal-footer rsvp-button-wrp">
                    ...
                    <a href="{{ asset('assets/front/csv/yesvite_contacts_csv_template.csv') }}" 
                            download="yesvite_contacts_csv_template.csv" 
                            type="button" 
