            ...
            <div class="col-xxl-9 col-xl-8 col-lg-8 col-md-7">
                ...
                <div class="contact-tab contact-user">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="phone-tab" data-bs-toggle="tab" data-bs-target="#phone" type="button" role="tab" aria-controls="phone" aria-selected="false">Groups</button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active position-relative" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <div class="product-scroll" id="product-scroll">
                                ...
                                <div class="user-contacts group_list group_search_list">
                                    <div class="group-card added_group16 listgroups" data-id="16">
                                        ...
                                        <span class="ms-auto me-3">
                                            <svg width="16" id="delete_group" data-id="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="group-card added_group17 listgroups" data-id="17">
                                        <div class="view_members" data-id="17">
                                            <h4>test grp2</h4>
                                            <p>2 Guests</p>
                                        </div>
                                        <span class="ms-auto me-3">
                                            <svg width="16" id="delete_group" data-id="17" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M14 4.48665C11.78 4.26665 9.54667 4.15332 7.32 4.15332C6 4.15332 4.68 4.21999 3.36 4.35332L2 4.48665" stroke="#94A3B8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                                </path>
                                                <path d="M5.66699 3.81301L5.81366 2.93967C5.92033 2.30634 6.00033 1.83301 7.12699 1.83301H8.87366C10.0003 1.83301 10.087 2.33301 10.187 2.94634L10.3337 3.81301" stroke="#94A3B8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                                </path>
