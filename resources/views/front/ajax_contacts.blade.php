...
@if (!empty($yesvite_user))
        ...
        {{-- <div class="users-data">
            ...
            <a href="#" class="btn editt-yesvite-contact" id="edit_contact" onclick="return false;">Edit Contact</a>

        </div> --}}
        @if(isset($isGroup)&&$isGroup==1)
            <div class="users-data">
                <div class="d-flex align-items-start">
                    <div class="contact-img">
                        {{-- <img src="{{ asset('assets/event/image/user-img.svg') }}" alt="contact-img"> --}}
                        @if ($value->profile != '')
                        <img src="{{$value->profile}}" alt="user-img">
                        @else
                        @php
                        $firstInitial = !empty($value->firstname) ? strtoupper($value->firstname[0]) : '';
                        $lastInitial = !empty($value->lastname) ? strtoupper($value->lastname[0]) : '';
                ...
                <div class="text-start">
                    <h5 class="openProfileModal"  data-userid="{{ $value->id }}" style="text-decoration: underline;cursor: pointer;">{{ $value->firstname }}
                        {{ $value->lastname }}
                    </h5>
                ...
                <div class="d-flex flex-column user_choice_group" data-id="user-{{ $value->id }}">
                @if (isset($value->email) && $value->email != '')
                ...
                <div class="right-note ms-auto">
                    <input class="form-check-input user_group_member user_choice"
                        ...
                        data-preferby="phone" data-mobile="{{ $value->phone_number }}"
                        value="{{ $value->id }}">
                </div>
                @endif
                </div>
