...
@endif
<div>
    <li class="{{$message['unReadCount'] != '0' ?'active':''}} {{$i == 0 ?'active':''}} msg-list {{@$message['isPin']=='1'?'pinned':''}} conversation-{{@$message['conversationId']}} {{@$message['isArchive']=="1"?"archived-list":"unarchived-list"}}" data-userId="{{@$message['contactId']}}" data-msgKey={{$message['conversationId']}} data-group={{@$message['group']}}>
        ...
        <div class="chat-data d-flex align-items-start">
            ...
            <div class="ms-auto">
                ...
                <div class="d-flex align-items-center justify-content-end">
                    ...
                    <span class="ms-2 d-flex mt-1 align-items-start justify-content-end pin-svg {{$message['isPin']}} {{@$message['isPin']=='1'?'':'d-none'}}">
