...
data-msgKey={{$message['conversationId']}} data-group={{@$message['group']}}>
    ...
    <div class="chat-data d-flex align-items-center">
        ...
        <div class="dropdown ms-auto text-end">
            <button type="button" class="btn btn-primary dropdown-toggle usr-list-more" data-userid="{{@$message['contactId']}}" data-conversationId="{{$message['conversationId']}}" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item delete-single-conversation" data-message="{{$message['group']}}" href="#" data-conversation="{{$message['conversationId']}}" data-isGroup="{{@$message['group']}}">
                        <svg class="me-2" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
