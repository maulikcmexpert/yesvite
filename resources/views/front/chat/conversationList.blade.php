...
@endif                     --}}
{{-- @dd($message); --}}
<li class="{{$i == 0 ?'active':''}} msg-list conversation-{{$message['conversationId']}} unarchived-list" data-userId="{{$message['contactId']}}"  data-msgKey={{$message['conversationId']}} data-group={{@$message['group']}} >
