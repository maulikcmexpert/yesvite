...
data-msgKey={{$message['conversationId']}} data-group={{@$message['group']}}>
    ...
    <div class="chat-data d-flex align-items-center">
        ...
        <div class="dropdown ms-auto text-end">
            <button type="button" class="btn btn-primary dropdown-toggle usr-list-more" data-msgKey={{$message['conversationId']}} data-group={{@$message['group']}} data-userid="{{@$message['contactId']}}" data-conversationId="{{$message['conversationId']}}"  data-bs-toggle="dropdown" aria-expanded="false">
