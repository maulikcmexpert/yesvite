                                    ...
                                    <div class="chat-data d-flex align-items-start">
                                        ...
                                        <div class="dropdown ms-auto text-end">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item block-conversation" href="#" data-conversation="{{$message['conversationId']}}" user="{{@$message['contactId']}}" blocked="false">
                                                        <svg class="me-2" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="#" class="button-wrapper">
                                                    ...
                                                    <input type="file" name="upload" id="upload"  class="upload-box" accept="image/*" capture="camera" aria-label="Upload Camera File">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" class="button-wrapper">
                                                    ...
                                                    <input type="file" name="upload" id="upload"  class="upload-box" accept="image/*,video/*" aria-label="Upload Gallery File">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" class="button-wrapper">
                                                    ...
                                                    <input type="file" name="upload" id="upload"  class="upload-box" accept=".doc,.docx,.pdf,.txt" aria-label="Upload File">
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
