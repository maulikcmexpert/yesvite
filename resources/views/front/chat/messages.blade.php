                    ...
                    <a href="#" class="cmn-btn edit-btn" data-bs-toggle="modal" data-bs-target="#msgBox">
                        <svg class="me-1" width="21" height="20" viewBox="0 0 21 20" fill="none"
                            ...
                            <path d="M7.16406 10H13.8307" stroke="#64748B" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M10.5 13.3327V6.66602" stroke="#64748B" stroke-width="1.5"
                ...
                <div class="chat-area">
                                    ...
                                    <div class="chat-data d-flex align-items-center">
                                        ...
                                        <a href="#" class="user-detail d-block ms-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <h6 class="ms-2">Now</h6>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span>{{$message['lastMessage']}}</span>
                                                <span class="badge ms-2">2</span>
                                            </div>
                                        </a>
                    ...
                    <div class="chatbox position-relative w-100">
                        ...
                        <div class="msg-body">
                            <ul>
                                <li class="receiver">
                                    <p>Hello Helene! consectetur adipiscing elit ames.</p>
                                    <span class="time">09:10</span>
                                </li>
                                <li class="sender">
                                    <div>
                                        <p>Fames eros urna, felis morbi a est est.</p>
                                ...
                                <li class="receiver">
                                    <div>
                                        <img src="./assets/image/enjoy.png" alt="">
                                        I enjoy this party! 🎉
                                    </div>
