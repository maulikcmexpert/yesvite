                ...
                <div class="chat-area">
                    <div class="chat-lists">
                        ...
                        <ul class="chat-list">
                            ...
                            @endif
                            <div>
                                <li class="active {{$i == 0 ?'active':''}} msg-list {{@$message['isPin']=='1'?'pinned':''}} conversation-{{@$message['conversationId']}} {{@$message['isArchive']=="1"?"archived-list":"unarchived-list"}}" data-userId="{{@$message['contactId']}}" data-msgKey={{$k}} data-group={{@$message['group']}}>
