                                    ...
                                    <div class="chat-data d-flex align-items-start">
                                        ...
                                        <div class="dropdown ms-auto text-end">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item mute-single-conversation" href="#" data-conversation="{{$message['conversationId']}}">
                                                ...
                                                <li><a class="dropdown-item archive-single-conversation" href="#" data-conversation="{{$message['conversationId']}}">
                                                        <svg class="me-2" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
