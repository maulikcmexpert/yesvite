                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="#" class="button-wrapper">
                                                    ...
                                                    <input type="file" name="upload" class="upload-box" accept="image/*" capture="camera" aria-label="Upload Camera File">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" class="button-wrapper">
                                                    ...
                                                    <input type="file" name="upload" class="upload-box" accept="image/*,video/*" aria-label="Upload Gallery File">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" class="button-wrapper">
                                                    ...
                                                    <input type="file" name="upload" class="upload-box" accept=".doc,.docx,.pdf,.txt" aria-label="Upload File">
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
