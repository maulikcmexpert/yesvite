                                            ...
                                            <ul class="dropdown-menu">
                                                {{-- <li><a class="dropdown-item" href="#"><svg class="me-2" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <a class="dropdown-item pin-single-conversation" href="#" changewith="{{@$message['isPin']=='1'?'0':'1'}}">
                                                        ...
                                                        <svg class="me-2 unpin-single-conversation unpin1-self-icn {{@$message['isPin']=='1'?'':'d-none'}}" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368" style="display: none;">
