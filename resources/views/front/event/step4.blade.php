    ...
    <div class="setting-wrp">
        <div class="setting-content">
                                    ...
                                    <div class="accordion-con">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="toggle-button-cover">
                                                <div class="button-cover">
                                                    <div class="button r" id="button-1">
                                                        <input type="checkbox" id="eventPhotos" name="notification_setting[]" onchange="savePage4Data()" class="checkbox event_page_checkbox" {{(isset($eventDetail['event_setting'])&&$eventDetail['event_setting']['event_photos']=="1") ? "checked":""}}/>
                                                        <div class="knobs"></div>
                                                        <div class="layer"></div>
                                                    </div>
                                                </div>
            ...
            {{-- <div class="guest-checkout">
                <div class="d-flex align-items-center final-checkout-guest-btn">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="cmn-btn cancel-btn potluck_cancel"
...
<div id="sidebar_addcategoryitem" class="sidebar setting-side-wrp">
    <div class="item-dishesh-sidebar add_sub_category ">
        <div class="d-flex align-items-center justify-content-between toggle-wrp add-item-head-wrp">
            <div class="d-flex align-items-center ">
