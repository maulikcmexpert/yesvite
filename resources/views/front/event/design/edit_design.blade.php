...
<main class="main-content-wrp edit-imag-main-content-wrp edit_design_template">
    <div class="main-content-right edit-image-main-wrp">
        ...
        <div class="design-seting">
            <button type="button" class="previousImeg">
                <span>
                ...
                <div class="uploaded-images-inner">
                    ...
                    <div class="uploaded-images-detail">
                        <div class="uploaded-img-card ">
                            ...
                            <button style="display: none" class="uploaded-img-card-delete delete-slider-1 delete_silder photo-edit-delete-1">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div class="uploaded-img-card">
                            ...
                            <button style="display: none" class="uploaded-img-card-delete delete-slider-2 delete_silder photo-edit-delete-2">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M14 3.98665C11.78 3.76665 9.54667 3.65332 7.32 3.65332C6 3.65332 4.68 3.71999 3.36 3.85332L2 3.98665"
                        ...
                        <div class="uploaded-img-card">
                            ...
                            <button style="display: none" class="uploaded-img-card-delete delete-slider-3 delete_silder photo-edit-delete-3">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M14 3.98665C11.78 3.76665 9.54667 3.65332 7.32 3.65332C6 3.65332 4.68 3.71999 3.36 3.85332L2 3.98665"
