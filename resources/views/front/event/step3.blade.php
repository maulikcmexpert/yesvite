                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="contact" role="tabpanel"
                            ...
                            <div class="position-relative">
                                <input type="search" class="search_user" placeholder="Search name" class="form-control">
                                <span>
                        ...
                        <div class="d-flex flex-column user_choice_group" data-id="user-{{$user->id}}">
                            ...
                            <div class="right-note ms-auto">
                                <input class="form-check-input user_tel-{{$user->id}} user_choice" type="checkbox"
                                    name="mobile[]" data-mobile="{{$user->phone_number}}"
                                    value="{{ $user->id }}">
                            </div>
                            @endif
                        </div>
                            ...
                            <div class="text-start">
                                ...
                                <div>
                                    <a href="mailto:silvia@gmail.com"><svg class="me-1"
                                        ...
                                        silvissassassasasssa@gmail.com</a>
                                </div>
                                <div>
                                    <a href="tel">
                                        <svg width="14" class="me-1" height="14"
