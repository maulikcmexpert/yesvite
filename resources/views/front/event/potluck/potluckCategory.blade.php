    ...
    <div class="category-list potluckCategorylist">
        <div class="list-header">
            ...
            <div class="ms-auto d-flex align-items-center ">
                <span class="me-1 missing-category-h6-{{$lastItemIndex}} missing-category-svg-{{$lastItemIndex}}" style="display: none;">
                ...
                <h6 class="me-3 missing-category-h6-{{$lastItemIndex}}" style="display: none;"><span id="missing-category-{{$lastItemIndex}}">{{$categoryQuantity}}</span> Missing</h6>

                {{-- NEW CODE --}}
                <span class="me-1 extra-category-h6-{{$lastItemIndex}} extra-category-svg-{{$lastItemIndex}}" style="display: none;">
                ...
                <h6 class="me-3 extra-category-h6-{{$lastItemIndex}}" style="display: none;color:#34C05C"><span id="extra-category-{{$lastItemIndex}}">{{$categoryQuantity}}</span> Item Over</h6>
