<div class="thank-you-card" id="thankyou{{$thankyou_template_id}}">
    <input class="form-check-input me-3" type="checkbox" name="select_thankyou[]" data-id="{{$thankyou_template_id}}">
    <div>
        <input type="hidden" id="edit_when_to_send" value="{{$when_to_send}}"/>
        <h5 id="edit_thankyou_template_name">{{$name}}</h5>
        <p id="edit_thankyou_message">{{$message}}</p>
    </div>
    <div class="d-flex ms-auto">
        <a href="#" class="me-3 edit_thankyou_card" data-id="{{$thankyou_template_id}}"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" >
        ...
        <a href="#" class="delete_thankyou_card" data-id="{{$thankyou_template_id}}">
