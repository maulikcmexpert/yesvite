...
<div class="users-data invited_use_see_all contact_model_tel-{{$guest_user['sync_id']}} sync_id-{{$guest_user['sync_id']}}"  data-id={{$guest_user['sync_id']}} id="user-{{$guest_user['sync_id']}}">
