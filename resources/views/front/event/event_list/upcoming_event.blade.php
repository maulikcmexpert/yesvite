                    ...
                    <div class="upcoming-events-card-notification-wrp dropdown">
                        ...
                        @if($upcomingEvent['is_notification_on_off']=='1')
                            <ul class="upcoming-events-card-notification-info dropdown-menu">
                                <li><button class="notification-btn" data-status="1" data-is_owner="{{$upcomingEvent['is_event_owner']}}"  data-event_id="{{$upcomingEvent['id']}}"><i class="fa-regular fa-bell"></i> Silence Notifications</button></li>
                            </ul>
                        @else
                            <ul class="upcoming-events-card-notification-info dropdown-menu">
                                <li><button class="notification-btn" data-status="0" data-is_owner="{{$upcomingEvent['is_event_owner']}}"  data-event_id="{{$upcomingEvent['id']}}"><i class="fa-regular fa-bell-slash"></i> Enable Notifications</button></li>
                            </ul>
                        @endif
                    </div>
                    @if($upcomingEvent['is_event_owner']==1)
                     <div class="dropdown upcoming-card-dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <button class="dropdown-item event_event_cancel_option" id="cancel_event_option" data-event_id="{{$events['id']}}" type="button" data-bs-toggle="modal" data-bs-target="#cancelevent">
                                        <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
