                ...
                <div class="new_event_detail_form_inner">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <lable for="end_event-date" id="end_event-date-error" class="error"></lable>
                        </div>
...
<div class="modal fade designModel" id="designModel" tabindex="-1" aria-labelledby="designModel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
            ...
            <div class="modal-body">
                ...
                <p>Continue to step 2 <b>details </b> page to save your progress</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn cancel-btn-createEvent" data-bs-dismiss="modal"
                    data-url="{{ route('home') }}">Discard & Exit</button>
                <button type="button" class="btn continue-btn" data-bs-dismiss="modal">Continue Editing</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade designModel" id="EditdesignModel" tabindex="-1" aria-labelledby="EditdesignModel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
