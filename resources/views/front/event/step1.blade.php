                    ...
                    <div class="col-6 mb-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group time start-time">
                                <input type="" class="form-control timepicker" placeholder="HH:MM AM/PM" id="start-time" name="start-time" onblur="clearError(this)" readonly /><span class="input-group-append input-group-addon"><span class="input-group-text"><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
