        ...
        <div class="new_event_detail_form">
            <form action="">
                ...
                <div class="row">
                        ...
                        <div class="add-activity-schedule" style="{{$style}}">
                            <h5 class="step_1_activity">
                                @if (isset($eventDetail['events_schedule_list']->data) && count($eventDetail['events_schedule_list']->data) > 0)
                                  <p id="isolddata">  {{count($eventDetail['events_schedule_list']->data)}} Activity    </p>   
                                @else
                                    <span><i class="fa-solid fa-triangle-exclamation"></i></span>Setup activity schedule
                                @endif
                               <p id="isnewdata" style="display: none"> <span><i class="fa-solid fa-triangle-exclamation"></i></span>Setup activity schedule</p>
                            </h5>
                    ...
                    <div class="col-6 mb-4 end_time" style="{{ (isset($eventDetail['rsvp_end_time_set']) && $eventDetail['rsvp_end_time_set'] !== '0') ? '' : 'display: none;' }}">
                        <div class="form-group end-time-wrp">
                            ...
                            <div class="input-group time timepicker">
                                <input type="text" class="form-control end_timepicker end-time-create" placeholder="HH:MM AM/PM" id="end-time" 
                                value="{{(isset($eventDetail['rsvp_end_time']) && $eventDetail['rsvp_end_time'] != '')?$eventDetail['rsvp_end_time']:''}}" name="end-time" onblur="clearError(this)" readonly /><span class="input-group-append input-group-addon"><span class="input-group-text"><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M18.8334 9.99984C18.8334 14.5998 15.1 18.3332 10.5 18.3332C5.90002 18.3332 2.16669 14.5998 2.16669 9.99984C2.16669 5.39984 5.90002 1.6665 10.5 1.6665C15.1 1.6665 18.8334 5.39984 18.8334 9.99984Z" stroke="#64748B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M13.5917 12.65L11.0083 11.1083C10.5583 10.8416 10.1917 10.2 10.1917 9.67497V6.2583" stroke="#64748B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg></span></span>
                            </div>
                    ...
                    <div class="col-12 mb-4">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="toggle-button-cover ">
                                <div class="button-cover">
                                    <div class="button r" id="button-1">
                                        <input type="checkbox" class="checkbox" id="isCheckAddress" {{(isset($eventDetail['address_1']) && $eventDetail['address_1']!='')?'checked':''}}>
                                        <div class="knobs"></div>
                                        <div class="layer"></div>
                                    </div>
                                </div>
                    ...
                    <div class="col-12 mb-4 ckeckedAddress" style="{{(isset($eventDetail['address_1']) && $eventDetail['address_1']!='')?'':'display:none'}}">
                    ...
                    <div class="col-6 mb-4 ckeckedAddress" style="{{(isset($eventDetail['address_1']) && $eventDetail['address_1']!='')?'':'display:none'}}">
                        <div class="input-form">
                            ...
                            <div class="ac-end-time" style="display: block;"> 
                                ...
                                <div class="col-12 ac-end-time" style="display: block;">
                                    <div class="form-group">
                                        <label>End Time</label>
                                        <div class="input-group time ">
                                            <input class="form-control end_timepicker" placeholder="HH:MM AM/PM" id="ac-end-time" name="ac-end-time" oninput="clearError()" value="{{$schedule_end_time->format('g:i A')}}" required="" readonly=""><span class="input-group-append input-group-addon"><span class="input-group-text"><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M18.8334 9.99984C18.8334 14.5998 15.1 18.3332 10.5 18.3332C5.90002 18.3332 2.16669 14.5998 2.16669 9.99984C2.16669 5.39984 5.90002 1.6665 10.5 1.6665C15.1 1.6665 18.8334 5.39984 18.8334 9.99984Z" stroke="#64748B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M13.5917 12.65L11.0083 11.1083C10.5583 10.8416 10.1917 10.2 10.1917 9.67497V6.2583" stroke="#64748B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                            </svg></span></span>
                                        </div>
                                    </div>
