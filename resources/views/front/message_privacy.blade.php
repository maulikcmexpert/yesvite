            ...
            <div class="col-xxl-9 col-xl-8 col-lg-8 col-md-7">
                <div class="contact-list">
                    ...
                    <div class="contact-title">
                        <h3>
                            Messaging Privacy</h3>
                        <a href="#" class="cmn-btn save-btn loaderbtn" id="messagePrivacySave">
                            Save Changes</a>
                    </div>
                    <form method="POST" action="" id="messagePrivacy">

                        <div class="privacy-wrapper">
                            <p class="border-bottom pt-0">Who can direct message you (DM)?</p>
                                ...
                                <div>
                                    <div class="form-check d-flex align-items-center justify-content-between border-bottom">
                                        <label class="form-check-label d-flex mb-0" for="flexRadioDefault1">
                                            ...
                                            <div>
                                                <h6>Only guests from events</h6>
                                            </div>
                                        </label>
                                        <input class="form-check-input" type="radio" name="message_privacy" value="1" id="flexRadioDefault1" {{($user->message_privacy == '1')?'checked':''}}>
                                    </div>
                                </div>
                                <div>
                                    <div class="form-check d-flex align-items-center justify-content-between border-bottom">
                                        <label class="form-check-label d-flex mb-0" for="flexRadioDefault2">
                                            ...
                                            <div>
                                                ...
                                                <span>Direct messaging will be disabled</span>
                                            </div>
                                        </label>
                                        <input class="form-check-input" type="radio" name="message_privacy" value="3" id="flexRadioDefault2" {{($user->message_privacy == '3')?'checked':''}}>
                                    </div>
                                </div>
                            </div>
                        </div>
