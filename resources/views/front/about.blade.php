   ...
   <section class="event-planing">
       <div class="container">
           <div class="content">
               <h2 class="wow fadeInDown" data-wow-duration="8s" data-wow-delay="0" data-wow-offset="0">Event Planning 2.0</h2>
               <h6 class="wow fadeInDown" data-wow-duration="10s" data-wow-delay="0" data-wow-offset="0">At <span>Yesvite</span>, we believe in the power of personal connections and the importance of
                   ...
                   today!</h6>
               <h6 class="wow fadeInDown" data-wow-duration="12s" data-wow-delay="0" data-wow-offset="0">Start planning today!</h6>
           </div>
       </div>
   </section>
    @php
   ...
   <section class="join-us">
       ...
       <img class="left-img wow fadeInLeft" data-wow-duration="3s" data-wow-delay="0" data-wow-offset="0" src="{{asset('assets/front/image/left-banner.png')}}" alt="left-banner">
       <img class="right-img wow fadeInRight" data-wow-duration="3s" data-wow-delay="0" data-wow-offset="0" src="{{asset('assets/front/image/right-banner.png')}}" alt="right-banner">
   </section>