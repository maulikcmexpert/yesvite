                        ...
                        <defs>
                            <filter id="filter0_d_7906_43769" x="76" y="24" width="64" height="41"
                                ...
                                <feBlend mode="normal" in2="BackgroundImageFix"
                                    result="effect1_dropShadow_7906_43769" />
...
@else<header class="login-header">
    <div class="container-fluid">
        <nav class="navbar navbar-expand-md navbar-dark">
...
<main class="main-content-wrp">
    ...
    <input type="hidden"
        ...
        id="current_step">
    <input type="hidden" value="{{ isset($eventDetail) && !empty($eventDetail) ? json_encode($eventDetail) : '' }}"
        id="eventDetail" />
...
<div id="sidebar_add_co_host" class="sidebar setting-side-wrp">
    <div class="sidebar-content setting-sidebar">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="phone-tab-cantact" data-bs-toggle="tab" data-bs-target="#phone"
                    type="button" role="tab" aria-controls="phone" aria-selected="false">Phone
                    Contacts</button>
            </li>
        </ul>
        @if (Auth::guard('web')->check())
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                ...
                <div class="position-relative">
                    ...
                    <input type="search" placeholder="Search name" class="form-control phone_co_host_search"
                        style="display:none;">
    ...
    <div class="sidebar-content setting-sidebar">
        ...
        <div class="guest-group-name login-form-wrap add-category-new-wrp">
            <form action="" class="registry-form">
                <div class="input-form">
                    <input class="form-control" type="text" id="recipient_name" maxlength="30"
                        onkeyup="clearError(this)" name="recipient_name">
...
<div class="modal fade designModel" id="EditdraftModel" tabindex="-1" aria-labelledby="EditdraftModel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                        ...
                        <div class="plan-inner-card-body">
                            <ul class="plan-inner-card-list">
                                ...
                                <li class="plan-inner-card-item">
                                    ...
                                    <h5> <span class="plan-inner-card-title">Cleaner invites </span> (no ads,looks more professional)</h5>
                                </li>
                                <li class="plan-inner-card-item">
                                    <div class="icon">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h5> <span class="plan-inner-card-main-text">Photo Section </span> (better guest experience,smoother flow)</h5>
                                </li>
                                <li class="plan-inner-card-item">
                                    <div class="icon">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h5>Guests can leave video RSVP's</h5>
                                </li>
                            </ul>
                            @if($coins==0)
