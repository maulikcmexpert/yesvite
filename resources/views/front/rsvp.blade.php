   ...
   <section class="rsvp-wrp new-main-content">
       ...
       <div class="mx-auto adsense-center ads-responsive" style="text-align: center;">
        ...
        style="display:inline-block;width:260px;height:70px"
       ...
       <div class="rsvp-tab-wrp event-center-tabs-main">
           ...
           <nav>
               <div class="nav nav-tabs" id="nav-tab" role="tablist">
                   <button class="nav-link active" data-tab="invite_tab" id="nav-invite-tab" data-bs-toggle="tab"
                       data-bs-target="#nav-invite" type="button" role="tab" aria-controls="nav-invite"
                       aria-selected="true">
                       Invite
                   </button>
                   @if (Auth::guard('web')->check())
                       <button class="nav-link" id="nav-messaging-tab" data-bs-toggle="tab"
                           data-bs-target="#nav-messaging" type="button" role="tab" aria-controls="nav-messaging"
                           aria-selected="false">
                           Messaging
                       </button>
                   @endif
           ...
           <div class="container">
               <div class="tab-content" id="nav-tabContent">
                           ...
                           <div class="container">
                               <div class="row mt-4">
                                   <div class="col-lg-5 mb-lg-0 mb-sm-4 mb-md-4 mb-0">
                                       <div
                                           class="rsvp-slider owl-carousel owl-theme {{ $eventInfo['guest_view']['event_images'] != '' && count($eventInfo['guest_view']['event_images']) > 1 ? 'slider-count' : '' }} ">
                                           @if ($eventInfo['guest_view']['event_images'] != '')
                                               @foreach ($eventInfo['guest_view']['event_images'] as $value)
                                                   <div class="item">
                                                       ...
                                                       <div class="rsvp-img open-event-images"
                                                           data-img="{{ asset($value) }}">
                                   ...
                                   <div class="col-lg-7">
                                       ...
                                       <div class="rsvp-form">
                                           ...
                                           <div class="author-wrp">
                                               <div class="author-img">
                                                   @if ($eventInfo['guest_view']['user_profile'] != '')
                                                       <img src="{{ $eventInfo['guest_view']['user_profile'] }}"
                                                           alt="">
                                                   @else
                                                       @php
                                                           $firstInitial = !empty(
                                                               $eventInfo['guest_view']['host_first_name']
                                                           )
                                                               ? strtoupper(
                                                                   $eventInfo['guest_view']['host_first_name'][0],
                                                               )
                                                               : '';
                                                           $lastInitial = !empty(
                                                               $eventInfo['guest_view']['host_last_name']
                                                           )
                                                               ? strtoupper(
                                                                   $eventInfo['guest_view']['host_last_name'][0],
                                                               )
                                                               : '';
                                               ...
                                               <div class="author-title">
                                                   ...
                                                   <p><span>Hosted by:
                                                       </span>{{ $eventInfo['guest_view']['hosted_by'] }}</p>
                                               </div>
                                           </div>
                                           ...
                                           <div class="rsvp-hosted-by-date-time-wrp">
                                                       ...
                                                       <div class="hosted-by-date-time-content">
                                                           ...
                                                           @php
                                                               ...
                                                               if ($eventInfo['guest_view']['event_end_date'] != '') {
                                                                   $event_end_date = Carbon::parse(
                                                                       $eventInfo['guest_view']['event_end_date'],
                                                                   )->format('F j, Y');
                                                                   $final_end_date = 'to ' . $event_end_date;
                                                               }
                                                               if (
                                                                   $eventInfo['guest_view']['event_end_date'] ==
                                                                   $eventInfo['guest_view']['event_date']
                                                               ) {
                                                                   $final_end_date = '';
                                                               }
                                                           @endphp
                                                           <h3>{{ Carbon::parse($eventInfo['guest_view']['event_date'])->format('F j, Y') }}
                                                               {{ $final_end_date }}</h3>
                                                           <input type="hidden" id="eventDate" name="eventDate"
                                                               value="{{ $eventInfo['guest_view']['event_date'] }}">
                                                           <input type="hidden" id="eventEndDate" name="eventDate"
                                                               value="{{ isset($eventInfo['guest_view']['event_end_date']) && $eventInfo['guest_view']['event_end_date'] != '' ? $eventInfo['guest_view']['event_end_date'] : '' }}">
                                                           <input type="hidden" id="eventTime" name="eventTime"
                                                               value="{{ $eventInfo['guest_view']['event_time'] }}">
                                                           <input type="hidden" id="eventName" name="eventName"
                                                               value="{{ $eventInfo['guest_view']['event_name'] }}">
                                                       </div>
                                                   </div>
                                                   <div class="hosted-by-date-time-left">
                                                       <div class="hosted-by-date-time-left-icon">
                                                       ...
                                                       <div class="hosted-by-date-time-content">
                                                           @php
                                                               ...
                                                               if ($eventInfo['guest_view']['event_end_time'] != '') {
                                                                   $final_end_time =
                                                                       'to ' .
                                                                       $eventInfo['guest_view']['event_end_time'];
                                                               }
                                                           @endphp
                                                           <h6>Time</h6>
                                                           {{-- <h3>8:00 to 10:00PM</h3> --}}
                                                           <h3>{{ $eventInfo['guest_view']['event_time'] }}
                                                               {{ $final_end_time }}</h3>
                                                       </div>
                                                       <input type="hidden" id="eventEndTime" name="eventEndTime"
                                                           value="{{ isset($eventInfo['guest_view']['event_end_time']) && $eventInfo['guest_view']['event_end_time'] != '' ? $eventInfo['guest_view']['event_end_time'] : '' }}">
                                                   </div>
                                               </div>
                                               <div class="accordion rsvp-calender-accordion" id="accordionExample">
                                                   <div class="accordion-item">
                                                       <h2 class="accordion-header" id="headingOne">
                                                           <button class="accordion-button add-calender btn"
                                                       ...
                                                       <div id="collapseOne" class="accordion-collapse collapse"
                                                        ...
                                                        <h3>
                                                            ...
                                                            ADD To
                                                               ...
                                                               <a href="javascript:;" id="openOutlook"
                                                                   class="add-calender btn">
                                                                   <svg width="50" height="50"
                                                                       viewBox="0 0 50 50" fill="none"
                                                                       xmlns="http://www.w3.org/2000/svg">
                                                                       <path
                                                                           d="M30.4453 12.4023V20.9602L33.4391 22.843C33.5471 22.8667 33.6591 22.8667 33.7672 22.843L46.6391 14.1648C46.6297 13.7437 46.4756 13.3386 46.2027 13.0176C45.9298 12.6966 45.5548 12.4794 45.1406 12.4023H30.4453Z"
                                                                           fill="#0072C6" />
                                                                       <path
                                                                           d="M30.4469 24.1531L33.1766 26.0281C33.3044 26.106 33.4511 26.1471 33.6008 26.1471C33.7504 26.1471 33.8972 26.106 34.025 26.0281C33.5563 26.3109 46.6391 17.625 46.6391 17.625V33.3531C46.6732 33.6718 46.6373 33.9941 46.5338 34.2975C46.4303 34.6009 46.2618 34.878 46.04 35.1094C45.8183 35.3408 45.5486 35.521 45.25 35.6373C44.9513 35.7536 44.6308 35.8033 44.3109 35.7828H30.4453L30.4469 24.1531Z"
                                                                           fill="#0072C6" />
                                                                       <path
                                                                           d="M16.3145 20.2071C15.861 20.2049 15.4153 20.3255 15.0247 20.556C14.6341 20.7865 14.3131 21.1184 14.0958 21.5165C13.5022 22.5718 13.2174 23.7727 13.2739 24.9821C13.2122 26.189 13.4974 27.3884 14.0958 28.4384C14.3122 28.8201 14.6252 29.1381 15.0035 29.3605C15.3818 29.5829 15.8119 29.7018 16.2507 29.7053C16.6894 29.7087 17.1214 29.5967 17.5032 29.3803C17.8849 29.164 18.203 28.851 18.4254 28.4727C19.0173 27.4276 19.2966 26.2345 19.2301 25.0352C19.2979 23.7983 19.0278 22.5663 18.4489 21.4712C18.242 21.0861 17.9338 20.7648 17.5577 20.542C17.1815 20.3192 16.7517 20.2034 16.3145 20.2071Z"
                                                                           fill="#0072C6" />
                                                                       <path
                                                                           d="M3.36719 8.05469V41.5344L28.8359 46.875V3.125L3.36719 8.05469ZM20.4109 30.4547C19.9345 31.1263 19.301 31.6713 18.5657 32.0419C17.8303 32.4126 17.0155 32.5977 16.1922 32.5812C15.3896 32.5955 14.5954 32.4157 13.8773 32.0572C13.1591 31.6986 12.5381 31.1719 12.0672 30.5219C10.9503 28.9625 10.3916 27.0722 10.4812 25.1563C10.3862 23.1463 10.9551 21.1609 12.1 19.5063C12.5825 18.8218 13.2259 18.2665 13.9736 17.8894C14.7213 17.5122 15.5503 17.3249 16.3875 17.3438C17.1843 17.3278 17.9728 17.5076 18.6838 17.8675C19.3949 18.2274 20.0067 18.7563 20.4656 19.4078C21.5714 21.001 22.1206 22.9145 22.0281 24.8516C22.1255 26.847 21.5566 28.8181 20.4109 30.4547Z"
                                                                           fill="#0072C6" />
                                                                   </svg>
                                                                   Outlook Calendar
                                                               </a>
                                                               <a href="javascript:;" id="openApple"
                                                                   class="add-calender btn">
                                                                   <svg width="50" height="50"
                                                                       viewBox="0 0 50 50" fill="none"
                                                                       xmlns="http://www.w3.org/2000/svg">
                                                                       <path fill-rule="evenodd" clip-rule="evenodd"
                                                                           d="M32.6772 7.98218C34.4999 5.8697 35.7285 2.92745 35.3923 0C32.7657 0.1 29.588 1.67787 27.7047 3.78784C26.0134 5.66032 24.5371 8.65224 24.934 11.5222C27.8639 11.7397 30.8545 10.0971 32.6772 7.98218ZM39.2475 26.5625C39.3208 34.1299 46.1742 36.6472 46.25 36.6797C46.1944 36.8572 45.1554 40.2666 42.64 43.7915C40.4634 46.8365 38.2059 49.8691 34.649 49.9341C31.1554 49.9966 30.0304 47.9492 26.0337 47.9492C22.0394 47.9492 20.7906 49.8688 17.484 49.9963C14.051 50.1188 11.4345 46.7019 9.24274 43.667C4.75809 37.4596 1.33266 26.1252 5.93361 18.4753C8.21891 14.6779 12.3016 12.2695 16.7357 12.2095C20.1055 12.147 23.2883 14.3823 25.3486 14.3823C27.4089 14.3823 31.2767 11.6948 35.3417 12.0898C37.0431 12.1573 41.821 12.7471 44.8874 17.0496C44.6397 17.1971 39.1868 20.2376 39.2475 26.5625Z"
                                                                           fill="black" />
                                                                   </svg>
                                                                   Apple Calendar
                                                               </a>
                                                               <a href="javascript:;" id="openGoogle"
                                                                   class="add-calender btn">
                                                                   <svg width="50" height="50"
                                                                       viewBox="0 0 50 50" fill="none"
                                                                       xmlns="http://www.w3.org/2000/svg">
                                                                       <path
                                                                           d="M46.8739 25.4839C46.8739 23.6853 46.725 22.3728 46.4027 21.0117H25.4453V29.1297H37.7469C37.4989 31.1472 36.1595 34.1853 33.1833 36.2269L33.1416 36.4987L39.768 41.5294L40.227 41.5742C44.4433 37.7583 46.8739 32.1436 46.8739 25.4839Z"
                                                                           fill="#4285F4" />
                                                                       <path
                                                                           d="M25.4483 46.873C31.475 46.873 36.5344 44.9284 40.23 41.5742L33.1862 36.2269C31.3014 37.5152 28.7715 38.4144 25.4483 38.4144C19.5456 38.4144 14.5357 34.5984 12.7498 29.3242L12.488 29.3459L5.59792 34.5717L5.50781 34.8172C9.17841 41.963 16.7181 46.873 25.4483 46.873Z"
                                                                           fill="#34A853" />
                                                                       <path
                                                                           d="M12.7479 29.3266C12.2767 27.9655 12.004 26.5071 12.004 25.0002C12.004 23.4932 12.2767 22.0349 12.7231 20.6738L12.7106 20.3838L5.73414 15.0742L5.50589 15.1806C3.99306 18.146 3.125 21.4758 3.125 25.0002C3.125 28.5244 3.99306 31.8543 5.50589 34.8196L12.7479 29.3266Z"
                                                                           fill="#FBBC05" />
                                                                       <path
                                                                           d="M25.4484 11.5833C29.6398 11.5833 32.4672 13.3576 34.0794 14.8403L40.3789 8.8125C36.51 5.2882 31.4751 3.125 25.4484 3.125C16.7181 3.125 9.17842 8.03469 5.50781 15.1805L12.7251 20.6736C14.5357 15.3993 19.5456 11.5833 25.4484 11.5833Z"
                                                                           fill="#EB4335" />
                                                                   </svg>
                                                                   Google Calendar
                                                               </a>
                                               ...
                                               <div class="new_copy_event_Wrp">
                                                   ...
                                                   <div class="new_copy_event_inner">
                                                       <input type="text" value="{{ $shortLink }}"
                                                           name="copy_link" id="copy_link" readonly />
                                           ...
                                           <div class="host-users-detail rsvp-host-users-detail cmn-card">
                                               ...
                                               <div class="host-user-con-box">
                                                   <div class="host-user-con">
                                                       ...
                                                       @if (Auth::guard('web')->check())
                                                           @if ($is_host == '')
                                                               ...
                                                               <a href="{{ route('message.list', ['id' => encrypt($eventInfo['guest_view']['host_id']), 'is_host' => '1']) }}"
                                                                   class="msg-btn host-msg"
                                                   ...
                                                   @if (!empty($eventInfo['guest_view']['co_hosts']))
                                                       ...
                                                       <div class="host-user-con">
                                                           <div class="img-wrp">
                                                               @if ($coHost['profile'] != '')
                                                                   <img src="{{ $coHost['profile'] }}"
                                                                       alt="host-img">
                                                               @else
                                                                   @php
                                                                       $firstInitial = !empty($coHost['first_name'])
                                                                           ? strtoupper($coHost['first_name'][0])
                                                                           : '';
                                                                       $lastInitial = !empty($coHost['last_name'])
                                                                           ? strtoupper($coHost['last_name'][0])
                                                                           : '';
                                                                       $initials = $firstInitial . $lastInitial;
                                                                       $fontColor = 'fontcolor' . $firstInitial;
                                                                   @endphp
                                                           ...
                                                           <h5>{{ $coHost['first_name'] }} {{ $coHost['last_name'] }}
                                                           </h5>
                                                           <span>Co-host</span>
                                                           @if (Auth::guard('web')->check())
                                                               {{-- <a href="#" class="msg-btn chost-msg">Message</a> --}}
                                                               <a href="{{ route('message.list', ['id' => encrypt($coHost['id']), 'is_host' => '0']) }}"
                                                                   class="msg-btn chost-msg"
                                                                   target="_blank">Message</a>
                                               ...
                                               <p>{{ $eventInfo['guest_view']['message_to_guests'] != '' ? '"' . $eventInfo['guest_view']['message_to_guests'] . '"' : '' }}
                                               </p>
                                           </div>
                                           <div class="location-wrp cmn-card rsvp-location-wrp">
                                               ...
                                               @if ($eventInfo['guest_view']['address_1'] != '')
                                                   <p class="evnt-address">{{ $eventInfo['guest_view']['address_1'] }}
                                                       {{ $eventInfo['guest_view']['city'] }},
                                                       {{ $eventInfo['guest_view']['state'] }}
                                                       {{ $eventInfo['guest_view']['zip_code'] }}</p>
                                                   <input type="hidden" id="event_latitude"
                                                       value="{{ $eventInfo['guest_view']['latitude'] }}" />
                                                   <input type="hidden" id="event_logitude"
                                                       value="{{ $eventInfo['guest_view']['logitude'] }}" />
                                                   <input type="hidden" id="event_address"
                                                       value="{{ $eventInfo['guest_view']['address_1'] }}" />
                                                   <div id="map">
                                                   ...
                                                   <a href="#" class="direction-btn"
                                                       data-lat="{{ $eventInfo['guest_view']['latitude'] }}"
                                                       data-long="{{ $eventInfo['guest_view']['logitude'] }}">Directions</a>
                                               @endif
                                           </div>
                                           <div class="guest-user-list rsvp-guest-user-list-wrp cmn-card">
                                            ...
                                            Guests)</h5> -->
                                                   ...
                                                   <a href="#" data-bs-toggle="modal"
                                                       data-bs-target="#rsvp-guest-list-modal">See All</a>
                                               </div>
                                               <div>
                                                   @php
                                                       $i = 0;
                                                   ...
                                                   @foreach ($getInvitedusers['all_invited_users'] as $guest_data)
                                                       @php
                                                           ...
                                                           if (
                                                               empty($user_id) &&
                                                               !empty($sync_contact_user_id) &&
                                                               $sync_contact_user_id == $guest_data['id']
                                                           ) {
                                                               $yes_modal = '#rsvp-yes-modal';
                                                               $no_modal = '#rsvp-no-modal';
                                                           }
                                                                   ...
                                                                   <div class="w-100">
                                                                       <div
                                                                           ...
                                                                           <div class="d-flex flex-column">
                                                                               <p href="#" class="guest-name">
                                                                                   {{ $guest_data['first_name'] }}
                                                                                   {{ $guest_data['last_name'] }}</p>
                                                                               <span
                                                                                   class="guest-email">{{ $guest_data['email'] != '' ? $guest_data['email'] : $guest_data['phone_number'] }}</span>
                                                                           </div>
                                                                           @if ($rsvp_status != '' && $user_id == $guest_data['id'])
                                                                               <button class="guest-list-edit-btn"
                                                                                   data-bs-toggle="modal"
                                                                                   data-bs-target={{ $open_modal }}>
                                                                                   <svg width="20" height="20"
                                                                                       viewBox="0 0 20 20"
                                                                                       fill="none"
                                                                                       xmlns="http://www.w3.org/2000/svg">
                                                                                       <path
                                                                                           d="M9.16406 1.66602H7.4974C3.33073 1.66602 1.66406 3.33268 1.66406 7.49935V12.4993C1.66406 16.666 3.33073 18.3327 7.4974 18.3327H12.4974C16.6641 18.3327 18.3307 16.666 18.3307 12.4993V10.8327"
                                                                                           stroke="#94A3B8"
                                                                                           stroke-width="1.5"
                                                                                       ...
                                                                                       <path
                                                                                           ...
                                                                                           stroke-linejoin="round" />
                                                                                       <path
                                                                                           d="M12.4219 3.45898C12.9802 5.45065 14.5385 7.00898 16.5385 7.57565"
                                                                                           stroke="#94A3B8"
                                                                                           stroke-width="1.5"
                                                                                           stroke-miterlimit="10"
                                                                                           stroke-linecap="round"
                                                                           ...
                                                                           @if ($guest_data['rsvp_status'] == '1')
                                                                               <div class="sucess-rsvp-wrp">
                                                                                   <div
                                                                                       ...
                                                                                       <h5
                                                                                           class="green d-flex align-items-center">
                                                                                           <svg width="16"
                                                                                               height="16"
                                                                                               viewBox="0 0 16 16"
                                                                                               fill="none"
                                           ...
                                           @if (!empty($eventInfo['guest_view']['event_schedule']))
                                               <div class="schedule-wrp rsvp-schedule-wrp cmn-card">
                                                   ...
                                                   @php
                                                       $event_start_time =
                                                           $eventInfo['guest_view']['event_timings']['start'];
                                                       $event_end_time = '';
                                                       if ($eventInfo['guest_view']['event_timings']['end'] != '') {
                                                           $event_end_time =
                                                               ' - ' . $eventInfo['guest_view']['event_timings']['end'];
                                                       }
                                                   @endphp
                                                   <span
                                                       class="timing">{{ $event_start_time }}{{ $event_end_time }}</span>
                                                   <div>
                                                           ...
                                                           @if ($schedule['type'] == '1')
                                                               <div class="shedule-manage-timing">
                                                                   ...
                                                                   <div class="shedule-box green">
                                                                       ...
                                                                       <span
                                                                           class="hrs ms-auto">{{ $schedule['total_time'] }}</span>
                                                                   </div>
                                                                   <img src="{{ asset('assets/front/image/timing-line.svg') }}"
                                                                       alt="timing">
                                                               </div>
                                                               ...
                                                               <a href="{{ $gift['registry_link'] }}"
                                                                   ...
                                                                   <div class="target d-flex gap-3 align-items-center">
                                                                       ...
                                                                       @php
                                                                           ...
                                                                           $logo = '';
                                                                           if (
                                                                               strpos($url, 'amazon') !== false ||
                                                                               strpos($url, 'Amazon') !== false
                                                                           ) {
                                                                               $logo = asset('assets/amazon.png');
                                                                           } elseif (
                                                                               strpos($url, 'target') !== false ||
                                                                               strpos($url, 'Target') !== false
                                                                           ) {
                                                                       ...
                                                                       <img src="{{ $logo }}"
                                                                           alt="">
                                                                       <div>
                                                                           <h5>{{ $gift['registry_recipient_name'] }}
                                                                           </h5>
                                           ...
                                           @if ($eventInfo['guest_view']['event_potluck'] != '0')
                                               <div class="note-wrp rsvp-note-wrp">
                                                   ...
                                                   @else
                                                       <h5><span>Note:</span> This is a Potluck Event</h5>
                                                       <p>Sign Up on iOS or Android Apps to let them know what you will
                                                           be brining.</p>
                                                   @endif
                           ...
                           @if ($rsvp_status == null || $rsvp_status == '')
                               @php
                                   ...
                                   $eventDateTime = strtotime(
                                       $eventInfo['guest_view']['event_date'] .
                                           ' ' .
                                           $eventInfo['guest_view']['event_time'],
                                   );
                                   ...
                                   <div class="rsvp-footer-btn-wrp">
                                       <div class="container">
                                           <div class="rsvp-footer-btn">
                                               ...
                                               <a href="javascript:void(0)" class="close_rsvp_footer">
                                                   <svg width="14" height="14" viewBox="0 0 14 14"
                                                       fill="none" xmlns="http://www.w3.org/2000/svg">
                                                       <path d="M1.16748 1.1665L12.8334 12.8324" stroke="#E2E8F0"
                                                           stroke-width="1.5" stroke-linecap="round"
                                                           stroke-linejoin="round"></path>
                                                       <path d="M1.16664 12.8324L12.8325 1.1665" stroke="#E2E8F0"
                                                           stroke-width="1.5" stroke-linecap="round"
                                                           stroke-linejoin="round"></path>
                                                   </svg>
                                               </a>
                                   ...
                                   @if ($eventDateTime >= $currentDateTime)
                                       <div class="rsvp-footer-btn-wrp">
                                           <div class="container">
                                               <div class="rsvp-footer-btn">
                                                   <div
                                                       class="d-flex align-items-center justify-content-end gap-3 w-100">
                                                       <h3>RSVP To This Event</h3>
                                                       <button class="cmn-btn check_rsvp_yes"
                                                           data-sync_id="{{ $sync_contact_user_id != '' ? encrypt($sync_contact_user_id) : '' }}"
                                                           data-event_id="{{ encrypt($event_id) }}"
                                                           data-user_id="{{ encrypt($user_id) }}"
                                                           data-bs-toggle="modal"
                                                           data-bs-target="#rsvp-yes-modal">Yes</button>
                                                       <button class="cmn-btn cmn-no-btn check_rsvp_no"
                                                           data-sync_id="{{ $sync_contact_user_id != '' ? encrypt($sync_contact_user_id) : '' }}"
                                                           data-event_id="{{ encrypt($event_id) }}"
                                                           data-user_id="{{ encrypt($user_id) }}"
                                                           data-bs-toggle="modal"
                                                           data-bs-target="#rsvp-no-modal">No</button>
                                                   </div>
                                               </div>
                                           </div>
                                       </div>
                   ...
                   <input type="hidden" id="co_host_profile" class="co_host_profile"
                       value="{{ $co_host_profile }}" />
                   <div class="tab-pane fade" id="nav-messaging" role="tabpanel"
                       ...
                       @if (($rsvp_status == '' && $is_host == '') || ($rsvp_status == null && $is_host == ''))
                           <div class="rsvp-no-msg-wrp">
                               ...
                               <div class="rsvp-no-msg-extra-text">
                                   <p><i class="fa-solid fa-circle-exclamation"></i> To participate in this
                                       conversation, you must RSVP.</p>
                               </div>
                           </div>
                                           ...
                                           <div class="rsvp-footer-btn">
                                               <div class="d-flex align-items-center justify-content-end gap-3 w-100">
                                                   ...
                                                   <button class="cmn-btn check_rsvp_yes"
                                                       data-sync_id="{{ $sync_contact_user_id != '' ? encrypt($sync_contact_user_id) : '' }}"
                                                       data-event_id="{{ encrypt($event_id) }}"
                                                       data-user_id="{{ encrypt($user_id) }}" data-bs-toggle="modal"
                                                       data-bs-target="#rsvp-yes-modal">Yes</button>
                                                   <button class="cmn-btn cmn-no-btn check_rsvp_no"
                                                       data-sync_id="{{ $sync_contact_user_id != '' ? encrypt($sync_contact_user_id) : '' }}"
                                                       data-event_id="{{ encrypt($event_id) }}"
                               ...
                               <div class="col-lg-12">
                                   <div class="chat-area">
                                       <div class="chat-lists message-chat-lists">
                                           <div class="chat-header">
                                               <div class="position-relative chat-header-searchbar">
                                                   <input type="text" placeholder="Search message"
                                                       name="search_user_from_list" id="serach_user_from_list">
                                               ...
                                               <div class=" chat-functions d-none">
                                                   <div class="d-flex align-items-center">
                                                       <span class="me-3 bulk-back">
                                                           <svg width="25" height="24" viewBox="0 0 25 24"
                                                               fill="none" xmlns="http://www.w3.org/2000/svg">
                                                               <path d="M10.07 5.92969L4 11.9997L10.07 18.0697"
                                                                   stroke="#0F172A" stroke-width="1.5"
                                                                   stroke-miterlimit="10" stroke-linecap="round"
                                                                   stroke-linejoin="round" />
                                                               <path d="M21.0019 12H4.17188" stroke="#0F172A"
                                                                   stroke-width="1.5" stroke-miterlimit="10"
                                                                   stroke-linecap="round" stroke-linejoin="round" />
                                                           </svg>
                                                       </span>
                                                   ...
                                                   <div class="ms-auto d-flex gap-3">
                                                       ...
                                                       <span class="multi-pin" changeWith="1">
                                                           <svg class="pin-icn" width="25" height="24"
                                                               viewBox="0 0 25 24" fill="none"
                                                               xmlns="http://www.w3.org/2000/svg">
                                                               <path
                                                                   d="M16.3908 4.36734L12.1481 8.60998L7.90549 10.0242L6.49128 11.4384L13.5623 18.5095L14.9766 17.0953L16.3908 12.8526L20.6334 8.60998"
                                                                   stroke="#64748B" stroke-width="1.5"
                                                                   stroke-linecap="round" stroke-linejoin="round" />
                                                               <path d="M10.0234 14.9746L6.4879 18.5101"
                                                                   stroke="#64748B" stroke-width="1.5"
                                                                   stroke-linecap="round" stroke-linejoin="round" />
                                                               <path d="M15.6797 3.66211L21.3365 9.31896"
                                                                   stroke="#64748B" stroke-width="1.5"
                                                                   stroke-linecap="round" stroke-linejoin="round" />
                                                           </svg>

                                                           <svg class="unpin-icn d-none"
                                                       ...
                                                       <span class="multi-mute" changeWith="1">
                                                           <svg width="25" height="24" viewBox="0 0 25 24"
                                                               fill="none" xmlns="http://www.w3.org/2000/svg">
                                                               <path
                                                                   d="M15.5 8.36979V7.40979C15.5 4.42979 13.43 3.28979 10.91 4.86979L7.99 6.69979C7.67 6.88979 7.3 6.99979 6.93 6.99979H5.5C3.5 6.99979 2.5 7.99979 2.5 9.99979V13.9998C2.5 15.9998 3.5 16.9998 5.5 16.9998H7.5"
                                                                   stroke="#64748B" stroke-width="1.5"
                                                                   stroke-linecap="round" stroke-linejoin="round" />
                                                               <path
                                                                   d="M10.9062 19.1292C13.4262 20.7092 15.4963 19.5592 15.4963 16.5892V12.9492"
                                                                   stroke="#64748B" stroke-width="1.5"
                                                                   stroke-linecap="round" stroke-linejoin="round" />
                                                               <path
                                                                   d="M19.31 9.41992C20.21 11.5699 19.94 14.0799 18.5 15.9999"
                                                                   stroke="#64748B" stroke-width="1.5"
                                                                   stroke-linecap="round" stroke-linejoin="round" />
                                                               <path
                                                                   d="M21.6481 7.80078C23.1181 11.2908 22.6781 15.3708 20.3281 18.5008"
                                                                   stroke="#64748B" stroke-width="1.5"
                                                                   stroke-linecap="round" stroke-linejoin="round" />
                                                               <path d="M22.5 2L2.5 22" stroke="#64748B"
                                                                   stroke-width="1.5" stroke-linecap="round"
                                                                   stroke-linejoin="round" />
                                                           </svg>
                                                       </span>
                                                       <span class="multi-archive" changeWith="1">
                                                           <svg width="25" height="24" viewBox="0 0 25 24"
                                                               fill="none" xmlns="http://www.w3.org/2000/svg">
                                                               <path
                                                                   d="M20 9.2207V18.0007C20 20.0007 19.5 21.0007 17 21.0007H8C5.5 21.0007 5 20.0007 5 18.0007V9.2207"
                                                                   stroke="#64748B" stroke-width="1.5"
                                                                   stroke-linecap="round" stroke-linejoin="round" />
                                                               <path
                                                                   d="M5.5 4H19.5C21.5 4 22.5 4.625 22.5 5.875V7.125C22.5 8.375 21.5 9 19.5 9H5.5C3.5 9 2.5 8.375 2.5 7.125V5.875C2.5 4.625 3.5 4 5.5 4Z"
                                                                   stroke="#64748B" stroke-width="1.5"
                                                                   stroke-linecap="round" stroke-linejoin="round" />
                                                               <path d="M10.6797 13H14.3197" stroke="#64748B"
                                                                   stroke-width="1.5" stroke-linecap="round"
                                                                   stroke-linejoin="round" />
                                                           </svg>
                                                       </span>
                                                       <span class="multi-delete">
                                                           <svg width="25" height="24" viewBox="0 0 25 24"
                                                               fill="none" xmlns="http://www.w3.org/2000/svg">
                                                               <path
                                                                   d="M21.5036 6.73046C21.4836 6.73046 21.4536 6.73046 21.4236 6.73046C16.1336 6.20046 10.8536 6.00046 5.62358 6.53046L3.58358 6.73046C3.16358 6.77046 2.79358 6.47046 2.75358 6.05046C2.71358 5.63046 3.01358 5.27046 3.42358 5.23046L5.46358 5.03046C10.7836 4.49046 16.1736 4.70046 21.5736 5.23046C21.9836 5.27046 22.2836 5.64046 22.2436 6.05046C22.2136 6.44046 21.8836 6.73046 21.5036 6.73046Z"
                                                                   fill="#64748B" />
                                                               <path
                                                                   d="M9.00074 5.72C8.96074 5.72 8.92074 5.72 8.87074 5.71C8.47074 5.64 8.19074 5.25 8.26074 4.85L8.48074 3.54C8.64074 2.58 8.86074 1.25 11.1907 1.25H13.8107C16.1507 1.25 16.3707 2.63 16.5207 3.55L16.7407 4.85C16.8107 5.26 16.5307 5.65 16.1307 5.71C15.7207 5.78 15.3307 5.5 15.2707 5.1L15.0507 3.8C14.9107 2.93 14.8807 2.76 13.8207 2.76H11.2007C10.1407 2.76 10.1207 2.9 9.97074 3.79L9.74074 5.09C9.68074 5.46 9.36074 5.72 9.00074 5.72Z"
                                                                   fill="#64748B" />
                                                               <path
                                                                   d="M15.7104 22.7496H9.29039C5.80039 22.7496 5.66039 20.8196 5.55039 19.2596L4.90039 9.18959C4.87039 8.77959 5.19039 8.41959 5.60039 8.38959C6.02039 8.36959 6.37039 8.67959 6.40039 9.08959L7.05039 19.1596C7.16039 20.6796 7.20039 21.2496 9.29039 21.2496H15.7104C17.8104 21.2496 17.8504 20.6796 17.9504 19.1596L18.6004 9.08959C18.6304 8.67959 18.9904 8.36959 19.4004 8.38959C19.8104 8.41959 20.1304 8.76959 20.1004 9.18959L19.4504 19.2596C19.3404 20.8196 19.2004 22.7496 15.7104 22.7496Z"
                                                                   fill="#64748B" />
                                                               <path
                                                                   d="M14.1581 17.25H10.8281C10.4181 17.25 10.0781 16.91 10.0781 16.5C10.0781 16.09 10.4181 15.75 10.8281 15.75H14.1581C14.5681 15.75 14.9081 16.09 14.9081 16.5C14.9081 16.91 14.5681 17.25 14.1581 17.25Z"
                                                                   fill="#64748B" />
                                                               <path
                                               ...
                                               <div class="dropdown ms-auto bulk-edit-option">
                                                   <button type="button" class="btn btn-primary dropdown-toggle"
                                                       ...
                                                       <svg width="5" height="18" viewBox="0 0 5 18"
                                                           fill="none" xmlns="http://www.w3.org/2000/svg">
                                                           <path
                                                   ...
                                                   <ul class="dropdown-menu">
                                                       <li class="bulk-edit"><a class="dropdown-item"
                                                               href="#"><svg class="me-2" width="21"
                                                                   height="20" viewBox="0 0 21 20" fill="none"
                                                                   xmlns="http://www.w3.org/2000/svg">
                                                                   <path
                                                                       d="M10.499 13.6092C8.50729 13.6092 6.89062 11.9926 6.89062 10.0009C6.89062 8.00924 8.50729 6.39258 10.499 6.39258C12.4906 6.39258 14.1073 8.00924 14.1073 10.0009C14.1073 11.9926 12.4906 13.6092 10.499 13.6092ZM10.499 7.64258C9.19896 7.64258 8.14062 8.70091 8.14062 10.0009C8.14062 11.3009 9.19896 12.3592 10.499 12.3592C11.799 12.3592 12.8573 11.3009 12.8573 10.0009C12.8573 8.70091 11.799 7.64258 10.499 7.64258Z"
                                                                       fill="#94A3B8" />
                                                                   <path
                                                                       d="M10.4984 17.5158C7.3651 17.5158 4.40677 15.6824 2.37344 12.4991C1.4901 11.1241 1.4901 8.88242 2.37344 7.49909C4.4151 4.31576 7.37344 2.48242 10.4984 2.48242C13.6234 2.48242 16.5818 4.31576 18.6151 7.49909C19.4984 8.87409 19.4984 11.1158 18.6151 12.4991C16.5818 15.6824 13.6234 17.5158 10.4984 17.5158ZM10.4984 3.73242C7.80677 3.73242 5.23177 5.34909 3.43177 8.17409C2.80677 9.14909 2.80677 10.8491 3.43177 11.8241C5.23177 14.6491 7.80677 16.2658 10.4984 16.2658C13.1901 16.2658 15.7651 14.6491 17.5651 11.8241C18.1901 10.8491 18.1901 9.14909 17.5651 8.17409C15.7651 5.34909 13.1901 3.73242 10.4984 3.73242Z"
                                                                       fill="#94A3B8" />
                                                               </svg>
                                                               Bulk Edit</a>
                                                       </li>
                                           ...
                                           <input type="hidden" class="senderUser" id="senderUser"
                                               value="{{ $userId }}" />
                                           <input type="hidden" class="senderUserName"
                                               value="{{ $userName }}" />
                                           <ul class="chat-list">
                                               ...
                                               @foreach ($messages as $k => $message)
                                                   ...
                                                   @if ($i == 0 && @$message['isArchive'] != '1')
                                                       ...
                                                       <input type="hidden" class="selected_name"
                                                           value="{{ @$message['contactName'] }}" />
                                                       <input type="hidden" id="isGroup"
                                                           value="{{ @$message['group'] }}" />
                                                   @endif
                                                   <div>
                                                       <li data-position="{{ $i }}"
                                                           class="{{ @$message['unReadCount'] != '0' ? 'active' : '' }} {{ $i == 0 ? 'active' : '' }} msg-list {{ @$message['isPin'] == '1' ? 'pinned' : '' }} conversation-{{ @$message['conversationId'] }} {{ @$message['isArchive'] == '1' ? 'archived-list' : 'unarchived-list' }}"
                                                           data-userId="{{ @$message['contactId'] }}"
                                                           data-msgKey={{ $k }}
                                                           data-search="{{ $message['contactName'] }}"
                                                           data-group={{ @$message['group'] }}>
                                                           <div class="ms-1 d-none bulk-check">
                                                               <input class="form-check-input m-0" type="checkbox"
                                                                   name="checked_conversation[]"
                                                           ...
                                                           <div class="chat-data d-flex align-items-start">
                                                               <div class="user-img position-relative">
                                                                   @if ($message['receiverProfile'] !== '')
                                                                       <img class="img-fluid user-image user-img-{{ @$message['contactId'] }}"
                                                                           data-id={{ @$message['contactId'] }}
                                                                           src="{{ @$message['receiverProfile'] }}"
                                                                           alt="user img">
                                                                   @else
                                                                       @php
                                                                           ...
                                                                           $fontColor =
                                                                               'fontcolor' . strtoupper($initials[0]);
                                                                       @endphp
                                                                       <h5 class="{{ $fontColor }}">
                                                                           {{ $initials }}</h5>
                                                                   @endif
                                                               ...
                                                               <a href="javascript:"
                                                                   class="user-detail d-flex ms-3">
                                                                   <div
                                                                       class="d-flex align-items-start flex-column tp">
                                                                       <div
                                                                           class="d-flex align-items-center gap-2">
                                                                           <h3>{{ $message['contactName'] }}</h3>
                                                                           <span class="host-type d-none"></span>
                                                                       </div>
                                                                       @php
                                                                           $timestamp =
                                                                               $message['timeStamp'] ??
                                                                               now()->timestamp;
                                                                           $timeAgo = Carbon::createFromTimestampMs(
                                                                               $timestamp,
                                                                           )->diffForHumans();
                                                                       @endphp
                                                                       <div
                                                                           class="d-flex align-items-center justify-content-between">
                                                                           <span
                                                                               class="last-message">{{ $message['lastMessage'] }}</span>
                                                               ...
                                                               <div class="ms-auto">
                                                                   <h6 class="ms-2 time-ago"> {{ $timeAgo }}
                                                                   </h6>
                                                                   <div
                                                                       class="d-flex align-items-center justify-content-end">
                                                                       <span
                                                                           class="badge ms-2 {{ @$message['unReadCount'] == 0 ? 'd-none' : '' }}">{{ @$message['unReadCount'] }}</span>
                                                                       <span
                                                                           class="ms-2 d-flex mt-1 align-items-start justify-content-end pin-svg {{ @$message['isPin'] == '1' ? '' : 'd-none' }}">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a class="dropdown-item" href="#">Something else here</a></li>
                                                               ...
                                                               <div class="dropdown ms-auto text-end">
                                                                   <button type="button"
                                                                       class="btn btn-primary dropdown-toggle usr-list-more"
                                                                       data-bs-toggle="dropdown">
                                                                       <svg width="5" height="18"
                                                                           viewBox="0 0 5 18" fill="none"
                                                                           xmlns="http://www.w3.org/2000/svg">
                                                                           <path
                                                                               d="M1.5 9C1.5 9.26522 1.60536 9.51957 1.79289 9.70711C1.98043 9.89464 2.23478 10 2.5 10C2.76522 10 3.01957 9.89464 3.20711 9.70711C3.39464 9.51957 3.5 9.26522 3.5 9C3.5 8.73478 3.39464 8.48043 3.20711 8.29289C3.01957 8.10536 2.76522 8 2.5 8C2.23478 8 1.98043 8.10536 1.79289 8.29289C1.60536 8.48043 1.5 8.73478 1.5 9Z"
                                                                               stroke="#64748B" stroke-width="2"
                                                                   ...
                                                                   <ul class="dropdown-menu">
                                                                    ...
                                                                    <path d="M12.4981 21.0205C8.73812 21.0205 5.18813 18.8205 2.74812 15.0005C1.68813 13.3505 1.68813 10.6605 2.74812 9.00047C5.19812 5.18047 8.74813 2.98047 12.4981 2.98047C16.2481 2.98047 19.7981 5.18047 22.2381 9.00047C23.2981 10.6505 23.2981 13.3405 22.2381 15.0005C19.7981 18.8205 16.2481 21.0205 12.4981 21.0205ZM12.4981 4.48047C9.26813 4.48047 6.17813 6.42047 4.01813 9.81047C3.26813 10.9805 3.26813 13.0205 4.01813 14.1905C6.17813 17.5805 9.26813 19.5205 12.4981 19.5205C15.7281 19.5205 18.8181 17.5805 20.9781 14.1905C21.7281 13.0205 21.7281 10.9805 20.9781 9.81047C18.8181 6.42047 15.7281 4.48047 12.4981 4.48047Z" fill="#64748B" />
                                                                       ...
                                                                       <a class="dropdown-item pin-single-conversation"
                                                                           href="#"
                                                                           changewith="{{ @$message['isPin'] == '1' ? '0' : '1' }}"
                                                                           data-conversation="{{ $message['conversationId'] }}">

                                                                           <svg class="me-2 pin1-self-icn {{ @$message['isPin'] == '1' ? 'd-none' : '' }}"
                                                                               width="25" height="24"
                                                                               viewBox="0 0 25 24"
                                                                               fill="none"
                                                                               xmlns="http://www.w3.org/2000/svg">
                                                                               <path
                                                                                   ...
                                                                                   stroke-linejoin="round"></path>
                                                                               <path
                                                                                   d="M10.0234 14.9746L6.4879 18.5101"
                                                                                   stroke="#94A3B8"
                                                                                   stroke-width="1.5"
                                                                                   stroke-linecap="round"
                                                                                   stroke-linejoin="round"></path>
                                                                               <path
                                                                                   d="M15.6797 3.66211L21.3365 9.31896"
                                                                                   stroke="#94A3B8"
                                                                                   stroke-width="1.5"
                                                                                   stroke-linecap="round"
                                                                                   stroke-linejoin="round"></path>
                                                                           ...
                                                                           <svg class="me-2 unpin-single-conversation unpin1-self-icn {{ @$message['isPin'] == '1' ? '' : 'd-none' }}"
                                                                               xmlns="http://www.w3.org/2000/svg"
                                                                               height="24px"
                                                                       ...
                                                                       <li><a class="dropdown-item mute-single-conversation"
                                                                               changeWith="{{ @$message['isMute'] == '1' ? '0' : '1' }}"
                                                                               href="#"
                                                                               data-conversation="{{ $message['conversationId'] }}">
                                                                               <svg class="me-2"
                                                                                   width="21" height="20"
                                                                                   ...
                                                                                   xmlns="http://www.w3.org/2000/svg">
                                                                                   <path
                                                                                       d="M6.33073 14.7926H4.66406C2.6474 14.7926 1.53906 13.6843 1.53906 11.6676V8.33428C1.53906 6.31762 2.6474 5.20928 4.66406 5.20928H5.85573C6.0474 5.20928 6.23906 5.15095 6.40573 5.05095L8.83906 3.52595C10.0557 2.76762 11.2391 2.62595 12.1724 3.14262C13.1057 3.65928 13.6141 4.73428 13.6141 6.17595V6.97595C13.6141 7.31762 13.3307 7.60095 12.9891 7.60095C12.6474 7.60095 12.3641 7.31762 12.3641 6.97595V6.17595C12.3641 5.22595 12.0724 4.51762 11.5641 4.24262C11.0557 3.95928 10.3057 4.08428 9.4974 4.59262L7.06406 6.10928C6.70573 6.34262 6.28073 6.45928 5.85573 6.45928H4.66406C3.3474 6.45928 2.78906 7.01762 2.78906 8.33428V11.6676C2.78906 12.9843 3.3474 13.5426 4.66406 13.5426H6.33073C6.6724 13.5426 6.95573 13.826 6.95573 14.1676C6.95573 14.5093 6.6724 14.7926 6.33073 14.7926Z"
                                                                                       fill="#94A3B8" />
                                                                                   <path
                                                                                       d="M10.9577 17.1577C10.2993 17.1577 9.57434 16.9244 8.84934 16.466C8.55767 16.2827 8.46601 15.8993 8.64934 15.6077C8.83267 15.316 9.21601 15.2243 9.50767 15.4077C10.316 15.9077 11.066 16.041 11.5743 15.7577C12.0827 15.4743 12.3743 14.766 12.3743 13.8243V10.791C12.3743 10.4493 12.6577 10.166 12.9993 10.166C13.341 10.166 13.6243 10.4493 13.6243 10.791V13.8243C13.6243 15.2577 13.1077 16.341 12.1827 16.8577C11.8077 17.0577 11.391 17.1577 10.9577 17.1577Z"
                                                                                       fill="#94A3B8" />
                                                                                   <path
                                                                                       d="M15.5002 13.9586C15.3669 13.9586 15.2419 13.9169 15.1252 13.8336C14.8502 13.6253 14.7919 13.2336 15.0002 12.9586C16.0502 11.5586 16.2752 9.70026 15.6002 8.09193C15.4669 7.77526 15.6169 7.4086 15.9336 7.27526C16.2502 7.14193 16.6169 7.29193 16.7502 7.6086C17.6002 9.62526 17.3086 11.9669 16.0002 13.7169C15.8752 13.8753 15.6919 13.9586 15.5002 13.9586Z"
                                                                                       fill="#94A3B8" />
                                                                                   <path
                                                                                       d="M17.0237 16.0423C16.8903 16.0423 16.7653 16.0007 16.6487 15.9173C16.3737 15.709 16.3153 15.3173 16.5237 15.0423C18.307 12.6673 18.6987 9.48399 17.5487 6.74232C17.4153 6.42565 17.5653 6.05899 17.882 5.92565C18.207 5.79232 18.5653 5.94232 18.6987 6.25899C20.0237 9.40899 19.5737 13.059 17.5237 15.7923C17.407 15.959 17.2153 16.0423 17.0237 16.0423Z"
                                                                                       fill="#94A3B8" />
                                                                                   <path
                                                                                       d="M2.16979 18.9576C2.01146 18.9576 1.85313 18.8992 1.72812 18.7742C1.48646 18.5326 1.48646 18.1325 1.72812 17.8909L18.3948 1.22422C18.6365 0.982552 19.0365 0.982552 19.2781 1.22422C19.5198 1.46589 19.5198 1.86589 19.2781 2.10755L2.61146 18.7742C2.48646 18.8992 2.32812 18.9576 2.16979 18.9576Z"
                                                                                       fill="#94A3B8" />
                                                                               </svg>
                                                                               <span>{{ @$message['isMute'] == '1' ? 'Unmute' : 'Mute' }}</span></a>
                                                                       </li>
                                                                       <li><a class="dropdown-item archive-single1-conversation"
                                                                               changeWith="{{ @$message['isArchive'] == '1' ? '0' : '1' }}"
                                                                               href="#"
                                                                               data-conversation="{{ $message['conversationId'] }}">
                                                                               <svg class="me-2"
                                                                                   width="21" height="20"
                                                                                   ...
                                                                                   xmlns="http://www.w3.org/2000/svg">
                                                                                   <path
                                                                                       d="M16.75 7.68359V15.0003C16.75 16.6669 16.3333 17.5003 14.25 17.5003H6.75C4.66667 17.5003 4.25 16.6669 4.25 15.0003V7.68359"
                                                                                       stroke="#94A3B8"
                                                                                       stroke-width="1.5"
                                                                                       stroke-linecap="round"
                                                                                       stroke-linejoin="round" />
                                                                                   <path
                                                                                       d="M4.66406 3.33398H16.3307C17.9974 3.33398 18.8307 3.85482 18.8307 4.89648V5.93815C18.8307 6.97982 17.9974 7.50065 16.3307 7.50065H4.66406C2.9974 7.50065 2.16406 6.97982 2.16406 5.93815V4.89648C2.16406 3.85482 2.9974 3.33398 4.66406 3.33398Z"
                                                                                       stroke="#94A3B8"
                                                                                       stroke-width="1.5"
                                                                                       stroke-linecap="round"
                                                                                       stroke-linejoin="round" />
                                                                                   <path d="M8.98438 10.834H12.0177"
                                                                                       stroke="#94A3B8"
                                                                                       stroke-width="1.5"
                                                                                       stroke-linecap="round"
                                                                                       stroke-linejoin="round" />
                                                                       ...
                                                                       <li><a class="dropdown-item delete-single-conversation"
                                                                               href="#"
                                                                               data-conversation="{{ $message['conversationId'] }}"
                                                                               data-isGroup="{{ @$message['group'] }}">
                                                                               <svg class="me-2"
                                                                                   width="21" height="20"
                                                                                   viewBox="0 0 21 20"
                                                                                   fill="none"
                                                                       ...
                                                                       @if (!isset($message['group']) || $message['group'] == '0')
                                                                           <li><a class="dropdown-item block-conversation single"
                                                                                   href="#"
                                                                                   data-conversation="{{ $message['conversationId'] }}"
                                                                                   user="{{ @$message['contactId'] }}"
                                                                                   blocked="false">
                                                                                   <svg class="me-2"
                                                                                       width="21"
                                                                                       height="20"
                                                                       ...
                                                                       <li><a class="dropdown-item report-single-conversation"
                                                                               ...
                                                                               <svg class="me-2"
                                                                                   ...
                                                                                   xmlns="http://www.w3.org/2000/svg">
                                                                                   <path
                                                                                       d="M10.4974 18.9577C5.55573 18.9577 1.53906 14.941 1.53906 9.99935C1.53906 5.05768 5.55573 1.04102 10.4974 1.04102C15.4391 1.04102 19.4557 5.05768 19.4557 9.99935C19.4557 14.941 15.4391 18.9577 10.4974 18.9577ZM10.4974 2.29102C6.2474 2.29102 2.78906 5.74935 2.78906 9.99935C2.78906 14.2493 6.2474 17.7077 10.4974 17.7077C14.7474 17.7077 18.2057 14.2493 18.2057 9.99935C18.2057 5.74935 14.7474 2.29102 10.4974 2.29102Z"
                                                                                       fill="#94A3B8" />
                                                                                   <path
                                                                                       d="M10.5 11.4577C10.1583 11.4577 9.875 11.1743 9.875 10.8327V6.66602C9.875 6.32435 10.1583 6.04102 10.5 6.04102C10.8417 6.04102 11.125 6.32435 11.125 6.66602V10.8327C11.125 11.1743 10.8417 11.4577 10.5 11.4577Z"
                                                                                       fill="#94A3B8" />
                                                                                   <path
                                                                                       d="M10.4974 14.1664C10.3891 14.1664 10.2807 14.1414 10.1807 14.0997C10.0807 14.0581 9.98906 13.9997 9.90573 13.9247C9.83073 13.8414 9.7724 13.7581 9.73073 13.6497C9.68906 13.5497 9.66406 13.4414 9.66406 13.3331C9.66406 13.2247 9.68906 13.1164 9.73073 13.0164C9.7724 12.9164 9.83073 12.8247 9.90573 12.7414C9.98906 12.6664 10.0807 12.6081 10.1807 12.5664C10.3807 12.4831 10.6141 12.4831 10.8141 12.5664C10.9141 12.6081 11.0057 12.6664 11.0891 12.7414C11.1641 12.8247 11.2224 12.9164 11.2641 13.0164C11.3057 13.1164 11.3307 13.2247 11.3307 13.3331C11.3307 13.4414 11.3057 13.5497 11.2641 13.6497C11.2224 13.7581 11.1641 13.8414 11.0891 13.9247C11.0057 13.9997 10.9141 14.0581 10.8141 14.0997C10.7141 14.1414 10.6057 14.1664 10.4974 14.1664Z"
                                                                                       fill="#94A3B8" />
                                                                               </svg>
                                                                               Report</a>
                                                                       </li>
                                       ...
                                       <button id="archive-list" list="0" style="display: none;">Archive
                                           List</button>
                                   </div>
                                   <div class="chatbox position-relative w-100 message-view-box">
                                       <div class="msg-head">
                                           <div class="row">
                                               <div class="col-lg-8 col-7">
                                                   <a href="javascript:;"
                                                       class="d-flex align-items-center conversationId"
                                                       data-bs-toggle="modal" data-bs-target="#listBox">
                                                       <button id="backtomsg-btn">
                                                           <svg width="25" height="24"
                                                               ...
                                                               <path d="M10.07 5.92969L4 11.9997L10.07 18.0697"
                                                                   ...
                                                                   stroke-miterlimit="10" stroke-linecap="round"
                                                                   stroke-linejoin="round" />
                                                               <path d="M21.0019 12H4.17188" stroke="#64748B"
                                                                   stroke-width="1.5" stroke-miterlimit="10"
                                                                   stroke-linecap="round"
                                                                   stroke-linejoin="round" />
                                                           </svg>
                                                       ...
                                                       <div class="user-img">
                                                           <img id="selected-user-profile"
                                                               src="{{ asset('assets/front') }}/image/user-img.svg"
                                                               alt="user-img">
                                               ...
                                               <div class="col-lg-4 col-5">
                                                   <div class="dropdown ms-auto text-end">
                                                       ...
                                                       <ul class="dropdown-menu">
                                                           ...
                                                           <li>
                                                               <a class="dropdown-item pin-conversation"
                                                                   href="#">

                                                                   <svg class="me-2 pin-self-icn" width="25"
                                                           ...
                                                           <li><a class="dropdown-item mute-conversation"
                                                                   href="#">
                                                                   <svg class="me-2" width="21"
                                                           ...
                                                           <li><a class="dropdown-item archive-conversation"
                                                                   href="#">
                                                                   <svg class="me-2" width="21"
                                                                       height="20" viewBox="0 0 21 20"
                                                                       fill="none"
                                                           ...
                                                           <li><a class="dropdown-item delete-conversation"
                                                                   href="#">
                                                                   <svg class="me-2" width="21"
                                                                       height="20" viewBox="0 0 21 20"
                                                                       fill="none"
                                                           ...
                                                           <li><a class="dropdown-item block-conversation"
                                                                   href="#">
                                                                   <svg class="me-2" width="21"
                                                                       height="20" viewBox="0 0 21 20"
                                                                       fill="none"
                                                           ...
                                                           <li><a class="dropdown-item report-conversation"
                                                                   href="#">
                                                                   <svg class="me-2" width="21"
                                                                       height="20" viewBox="0 0 21 20"
                                                                       fill="none"
                                       ...
                                       <div class="msg-body" id="msgBody">
                                           ...
                                           <div class="empty-massage">
                                               <div class="empty-img">
                                                   <img src="{{ asset('assets/front') }}/image/empty-img.png"
                                                       alt="empty-img">
                                               </div>
                                       ...
                                       <div class="msg-footer">
                                           ...
                                           <div class="position-relative audio-music-player" id="musicContainer"
                                               ...
                                               <div class="audio-container" id="audioContainer">
                                                       ...
                                                       <div class="navigation">
                                                           ...
                                                           <div class="music-info">
                                                               <div class="progress-container progress-range">
                                                                   <div class="grey-bar">
                                                                       <svg width="800" height="52"
                                                                           viewBox="0 0 1000 52" fill="none"
                                                                           xmlns="http://www.w3.org/2000/svg">
                                                                           <path
                                                                               d="M6.06263 16.5495C6.06263 15.1414 4.92801 14 3.52839 14C2.12876 14 0.994141 15.1414 0.994141 16.5495V35.4505C0.994141 36.8586 2.12876 38 3.52839 38C4.92801 38 6.06263 36.8586 6.06263 35.4505V16.5495Z"
                                                                               fill="#94A3B8" />
                                                                           <path
                                                                               d="M17.09 22.5495C17.09 21.1414 15.9554 20 14.5557 20C13.1561 20 12.0215 21.1414 12.0215 22.5495V29.4505C12.0215 30.8586 13.1561 32 14.5557 32C15.9554 32 17.09 30.8586 17.09 29.4505V22.5495Z"
                                                                               fill="#94A3B8" />
                                                                           <path
                                                                               d="M28.1334 10.5495C28.1334 9.14143 26.9988 8 25.5992 8C24.1996 8 23.0649 9.14143 23.0649 10.5495V41.4505C23.0649 42.8586 24.1996 44 25.5992 44C26.9988 44 28.1334 42.8586 28.1334 41.4505V10.5495Z"
                                                                               fill="#94A3B8" />
                                                                           <path
                                                                               d="M39.1608 14.5495C39.1608 13.1414 38.0262 12 36.6265 12C35.2269 12 34.0923 13.1414 34.0923 14.5495V37.4505C34.0923 38.8586 35.2269 40 36.6265 40C38.0262 40 39.1608 38.8586 39.1608 37.4505V14.5495Z"
                                                                               fill="#94A3B8" />
                                                                           <path
                                                                               d="M50.1886 12.5495C50.1886 11.1414 49.054 10 47.6544 10C46.2547 10 45.1201 11.1414 45.1201 12.5495V39.4505C45.1201 40.8586 46.2547 42 47.6544 42C49.054 42 50.1886 40.8586 50.1886 39.4505V12.5495Z"
                                                                               fill="#94A3B8" />
                                                                           <path
                                                                               d="M61.2316 16.5495C61.2316 15.1414 60.097 14 58.6973 14C57.2977 14 56.1631 15.1414 56.1631 16.5495V35.4505C56.1631 36.8586 57.2977 38 58.6973 38C60.097 38 61.2316 36.8586 61.2316 35.4505V16.5495Z"
                                                                               fill="#94A3B8" />
                                                                           <path
                                                                               d="M72.2589 19.5495C72.2589 18.1414 71.1243 17 69.7247 17C68.325 17 67.1904 18.1414 67.1904 19.5495V32.4505C67.1904 33.8586 68.325 35 69.7247 35C71.1243 35 72.2589 33.8586 72.2589 32.4505V19.5495Z"
                                                                               fill="#94A3B8" />
                                                                           <path
                                                                               d="M83.2868 16.5495C83.2868 15.1414 82.1521 14 80.7525 14C79.3529 14 78.2183 15.1414 78.2183 16.5495V35.4505C78.2183 36.8586 79.3529 38 80.7525 38C82.1521 38 83.2868 36.8586 83.2868 35.4505V16.5495Z"
                                                                               fill="#94A3B8" />
                                                                           <path
                                                                               d="M94.3297 22.5495C94.3297 21.1414 93.1951 20 91.7955 20C90.3959 20 89.2612 21.1414 89.2612 22.5495V29.4505C89.2612 30.8586 90.3959 32 91.7955 32C93.1951 32 94.3297 30.8586 94.3297 29.4505V22.5495Z"
                                                                               fill="#94A3B8" />
                                                                           <path
                                                                               d="
z"
                                                                               fill="#94A3B8" />
                                                                           <path
                                                                               d="M987.967 16.5494C987.967 15.1414 986.832 14 985.433 14C984.033 14 982.898 15.1414 982.898 16.5494V35.4506C982.898 36.8586 984.033 38 985.433 38C986.832 38 987.967 36.8586 987.967 35.4506V16.5494Z"
                                                                               fill="#94A3B8" />
                                                                           <path
                                                                               d="M999.011 19.5494C999.011 18.1414 997.876 17 996.477 17C995.077 17 993.942 18.1414 993.942 19.5494V32.4506C993.942 33.8586 995.077 35 996.477 35C997.876 35 999.011 33.8586 999.011 32.4506V19.5494Z"
                                                                               fill="#94A3B8" />
                                                                       </svg>


                                                                   </div>
                                                                   <div class="pink-bar progress progress-bar"
                                                                       id="progress">
                                                                       <svg width="800" preventdefault="none"
                                                                           height="52" viewBox="0 0 1000 52"
                                                                           fill="none"
                                                                           xmlns="http://www.w3.org/2000/svg">
                                                                           <path
                                                                               d="M6.06263 16.5495C6.06263 15.1414 4.92801 14 3.52839 14C2.12876 14 0.994141 15.1414 0.994141 16.5495V35.4505C0.994141 36.8586 2.12876 38 3.52839 38C4.92801 38 6.06263 36.8586 6.06263 35.4505V16.5495Z"
                                                               ...
                                                               <audio class="audio audio_player recordedAudio"
                                                                   id="recordedAudio" controls
                                                   ...
                                                   <button class="close-audio-btn"><svg width="17"
                                           ...
                                           <div class="message-perent">
                                               ...
                                               <div class="d-flex ms-auto">
                                                   <div class="dropdown">
                                                       <button type="button"
                                                           class="btn btn-primary dropdown-toggle p-0"
                                                           data-bs-toggle="dropdown">
                                                           <svg class="me-3" width="25" height="24"
                                                               viewBox="0 0 25 24" fill="none"
                                                               xmlns="http://www.w3.org/2000/svg">
                                                               <path
                                                                   d="M12.7028 11.8002L11.2928 13.2102C10.5128 13.9902 10.5128 15.2602 11.2928 16.0402C12.0728 16.8202 13.3428 16.8202 14.1228 16.0402L16.3428 13.8202C17.9028 12.2602 17.9028 9.73023 16.3428 8.16023C14.7828 6.60023 12.2528 6.60023 10.6828 8.16023L8.26281 10.5802C6.92281 11.9202 6.92281 14.0902 8.26281 15.4302"
                                                                   stroke="#94A3B8" stroke-width="1.5"
                                                                   stroke-linecap="round"
                                                                   stroke-linejoin="round" />
                                                               <path
                                                                       ...
                                                                       <span class="label">
                                                                           <svg class="me-2" width="21"
                                                                               ...
                                                                               <path
                                                                                   ...
                                                                                   fill="#64748B" />
                                                                               <path
                                                                                   d="M9.66458 11.4576C9.50625 11.4576 9.34792 11.3992 9.22292 11.2742L7.55625 9.60755C7.31458 9.36589 7.31458 8.96589 7.55625 8.72422C7.79792 8.48255 8.19792 8.48255 8.43958 8.72422L10.1062 10.3909C10.3479 10.6326 10.3479 11.0326 10.1062 11.2742C9.98125 11.3992 9.82292 11.4576 9.66458 11.4576Z"
                                                                                   fill="#64748B" />
                                                                               <path
                                                                                   d="M12.9974 18.9577H7.9974C3.4724 18.9577 1.53906 17.0243 1.53906 12.4993V7.49935C1.53906 2.97435 3.4724 1.04102 7.9974 1.04102H12.1641C12.5057 1.04102 12.7891 1.32435 12.7891 1.66602C12.7891 2.00768 12.5057 2.29102 12.1641 2.29102H7.9974C4.15573 2.29102 2.78906 3.65768 2.78906 7.49935V12.4993C2.78906 16.341 4.15573 17.7077 7.9974 17.7077H12.9974C16.8391 17.7077 18.2057 16.341 18.2057 12.4993V8.33268C18.2057 7.99102 18.4891 7.70768 18.8307 7.70768C19.1724 7.70768 19.4557 7.99102 19.4557 8.33268V12.4993C19.4557 17.0243 17.5224 18.9577 12.9974 18.9577Z"
                                                                                   fill="#64748B" />
                                                                               <path
                                                                                   d="M18.8307 8.95841H15.4974C12.6474 8.95841 11.5391 7.85007 11.5391 5.00007V1.66674C11.5391 1.41674 11.6891 1.18341 11.9224 1.09174C12.1557 0.991739 12.4224 1.05007 12.6057 1.22507L19.2724 7.89174C19.4474 8.06674 19.5057 8.34174 19.4057 8.57507C19.3057 8.8084 19.0807 8.95841 18.8307 8.95841ZM12.7891 3.17507V5.00007C12.7891 7.15007 13.3474 7.70841 15.4974 7.70841H17.3224L12.7891 3.17507Z"
                                                                                   fill="#64748B" />
                                                                           </svg> File
                                                                       </span>
                                                                       <input type="file" name="upload"
                                                   ...
                                                   <div>
                                                       <div id="audioControls">
                                                           <button type="button" class="close-song"
                                                               style="display: none;">
                                                           ...
                                                           <button id="stopRecording" style="display: none;"><i
                                                                   class="fa-solid fa-pause"></i></button>
                                                           <button id="playRecording"
                                                               style="display: none;">Play Recording</button>
                                                           <button id="stopPlayback" style="display: none;">Stop
                                                               Playback</button>
                                                       </div>
                                                           ...
                                                           <span id="startRecording">
                                                               <svg width="25" height="24"
                                                                   ...
                                                                   <path
                                                                       ...
                                                                       stroke-linejoin="round" />
                                                                   <path
                                                                       d="M11.1094 6.42914C12.0094 6.09914 12.9894 6.09914 13.8894 6.42914"
                                                                       stroke="#94A3B8" stroke-width="1.5"
                                                                       stroke-linecap="round"
                                                                       stroke-linejoin="round" />
                                                                   <path
                                                                       d="M11.7031 8.55031C12.2331 8.41031 12.7831 8.41031 13.3131 8.55031"
                                                                       stroke="#94A3B8" stroke-width="1.5"
                                                                       stroke-linecap="round"
                                                                       stroke-linejoin="round" />
                                                                   <path d="M12.5 19V22" stroke="#94A3B8"
                                                                       stroke-width="1.5" stroke-linecap="round"
                                                                       stroke-linejoin="round" />
                                                               </svg>
                                                           </span>
   ...
   <div class="modal fade cmn-modal about-rsvp rsvp-yes-modal" id="rsvp-yes-modal" tabindex="-1"
       ...
       <div class="modal-dialog modal-dialog-centered">
           ...
           <div class="modal-content">
               ...
               <form method="POST" action="{{ route('rsvp.store') }}" id="rsvpYesForm">
                   @csrf
                   <input type="hidden" value="{{ $user_id != null ? encrypt($user_id) : '' }}" name="user_id"
                       id="user_id" />
                   <input type="hidden" value="{{ encrypt($event_id) }}" name="event_id"
                       id="event_id" />
                   <input type="hidden"
                       value="{{ $sync_contact_user_id != '' ? encrypt($sync_contact_user_id) : '' }}"
                       name="sync_id" id="sync_id" />
                   <input type="hidden"
                       value="{{ $event_invited_user_id != '' ? encrypt($event_invited_user_id) : '' }}"
                       name="event_invited_user_id" id="event_invited_user_id" />
                   <input type="hidden" value="{{ $isShare }}" name="isShare" />
                   <input type="hidden" value="1" name="rsvp_status" id="rsvp_status" />
                   <div class="modal-body">
                       <div class="d-flex align-items-center rsvp-yes-profile">
                           @if ($eventInfo['guest_view']['user_profile'] != '')
                               <img src="{{ $eventInfo['guest_view']['user_profile'] }}" alt="rs-img"
                                   class="about-rs-img">
                           @else
                               @php
                                   $firstInitial = !empty($eventInfo['guest_view']['host_first_name'])
                                       ? strtoupper($eventInfo['guest_view']['host_first_name'][0])
                                       : '';
                                   $lastInitial = !empty($eventInfo['guest_view']['host_last_name'])
                                       ? strtoupper($eventInfo['guest_view']['host_last_name'][0])
                                       : '';
                                   $initials = $firstInitial . $lastInitial;
                                   $fontColor = 'fontcolor' . $firstInitial;
                               @endphp
                           ...
                           @endif
                           <div>
                               <h4 class="modal-title" id="aboutsuccessLabel">
                                   {{ $eventInfo['guest_view']['event_name'] }}</h4>
                           ...
                           <div class="rsvp-input-form row">
                               <div class="col-lg-6">
                                   <div class="input-form">
                                       <input type="text" name="firstname" value="{{ $user_firstname }}"
                                           id="firstname" autocomplete="off"
                                           class="form-control inputText firstname yes_firstname"
                                           maxlength="50">
                               ...
                               <div class="col-lg-6">
                                   <div class="input-form">
                                       <input type="text" name="lastname" value="{{ $user_lastname }}"
                                           id="lastname" autocomplete="off"
                                           class="form-control inputText lastname yes_lastname" maxlength="50">
                                       <label for="Fname" class="form-label input-field floating-label">Last
                                           Name</label>
                                   </div>
                               ...
                               <div class="col-lg-12">
                                   <div class="input-form">
                                       <input type="email" name="email" id="email"
                                           ...
                                           class="form-control inputText" {{ $email != '' ? 'readonly' : '' }}>
                                       <label for="Fname" class="form-label input-field floating-label">Email
                                           Address</label>
                               ...
                               <div>
                                   ...
                                   <div class="qty-container ms-auto">
                                       ...
                                       <input type="number" name="adults" id="adults" value="0"
                                           class="input-qty" autocomplete="off" readonly>
                       ...
                       <div class="rsvp-msgbox">
                           <h5>Message</h5>
                           <div class="input-form">
                               <textarea class="form-control inputText message_to_host" id="message_to_host" autocomplete="off"
                                   name="message_to_host" message="" maxlength="200"></textarea>
                               <label for="Fname" class="form-label input-field floating-label">Message to
                                   send with your RSVP</label>
                           </div>
                           <div class="d-flex align-items-center">
                       ...
                       <div class="rsvp-yes-notification-wrp">
                           ...
                           <div class="form-check">
                               <input class="form-check-input notifications" type="checkbox"
                                   name="notifications[]" value="1" autocomplete="off"
                           ...
                           <div class="form-check">
                               <input class="form-check-input notifications" name="notifications[]"
                                   type="checkbox" value="wall_post" autocomplete="off"
                           ...
                           <div class="form-check">
                               <input class="form-check-input notifications" name="notifications[]"
                                   type="checkbox" value="guest_rsvp" autocomplete="off"
                                   id="flexCheckDefault1">
                               <label class="form-check-label" for="flexCheckDefault1">
   ...
   <!-- about no rsvp Modal -->
   <div class="modal fade cmn-modal about-rsvp rsvp-yes-modal rsvp-no-modal" id="rsvp-no-modal" tabindex="-1"
       aria-labelledby="aboutsuccessLabel" aria-hidden="true">
       <div class="modal-dialog modal-dialog-centered">
               ...
               <form method="POST" action="{{ route('rsvp.store') }}" id="rsvpNoForm">
                   ...
                   <div class="modal-body">
                       ...
                       <div class="rsvp-custom-radio guest-rsvp-attend">
                           ...
                           <div class="rsvp-input-form row">
                               <div class="col-lg-6">
                                   <div class="input-form">
                                       <input type="text" name="firstname" value="{{ $user_firstname }}"
                                           id="firstname" class="form-control inputText firstname no_firstname"
                               ...
                               <div class="col-lg-6">
                                   <div class="input-form">
                                       <input type="text" name="lastname" value="{{ $user_lastname }}"
                                           id="lastname" class="form-control inputText lastname no_lastname"
                                           autocomplete="off" maxlength="50">
                               ...
                               <div class="col-lg-12">
                                   <div class="input-form">
                                       @if ($email != '')
                                           <input type="email" name="email" id="email"
                                               value="{{ isset($email) && $email != '' ? $email : '' }}"
                                               class="form-control inputText" readonly>
                                       @else
                                           <input type="email" name="email" id="email"
                                               value="{{ isset($email) && $email != '' ? $email : '' }}"
                       ...
                       <div class="rsvp-msgbox">
                           ...
                           <div class="input-form">
                               <textarea class="form-control inputText message_to_host" id="message_to_host" autocomplete="off"
                                   name="message_to_host" maxlength="200"></textarea>
                               <label for="Fname" class="form-label input-field floating-label">Message to
                                   send with your RSVP</label>
                           </div>
                           <div class="d-flex align-items-center">
   ...
   <!-- about no rsvp Modal -->
   <div class="modal fade cmn-modal about-rsvp rsvp-yes-modal" id="rsvp-guest-list-modal" tabindex="-1"
       aria-labelledby="aboutsuccessLabel" aria-hidden="true">
       <div class="modal-dialog modal-dialog-centered">
           <div class="modal-content">
               <div class="modal-header">
               ...
               <div class="modal-body">
                   <div class="guest-user-list rsvp-guest-user-list-wrp">
                       @foreach ($getInvitedusers['all_invited_users'] as $guest_data)
                           ...
                           @endphp
                           {{-- @if ($is_host == '1' || $user_id == $guest_data['id'] || ($user_id != $guest_data['id'] && ($guest_data['rsvp_status'] == '1' || $guest_data['rsvp_status'] == '0'))) --}}
                           <div class="guest-user-box">
                               <div class="guest-list-data">
                                   <div class="guest-img">
                                       @if ($guest_data['profile'] != '')
                                       ...
                                       @else
                                           @php
                                               $firstInitial = !empty($guest_data['first_name'])
                                                   ? strtoupper($guest_data['first_name'][0])
                                                   : '';
                                               $lastInitial = !empty($guest_data['last_name'])
                                                   ? strtoupper($guest_data['last_name'][0])
                                                   : '';
                                               $initials = $firstInitial . $lastInitial;
                                               $fontColor = 'fontcolor' . $firstInitial;
                                           @endphp
                                   ...
                                   <div class="w-100">
                                       <div class="d-flex align-items-center justify-content-between">
                                           ...
                                           @if ($rsvp_status != '' && $user_id == $guest_data['id'])
                                               <button class="guest-list-edit-btn" data-bs-toggle="modal"
                                                   data-bs-target={{ $open_modal }}>
                                       ...
                                       @if ($is_host == '1')
                                           @if ($guest_data['rsvp_status'] == '1')
                                               <div class="sucess-yes" data-bs-toggle="modal"
                                                   data-bs-target="{{ $no_modal }}">
                                                   <h5 class="green">RSVP'd YES</h5>
                                                   <div class="sucesss-cat ms-auto">
                                           ...
                                           @elseif ($guest_data['rsvp_status'] == '0')
                                               <div class="sucess-no" sucess-yes data-bs-toggle="modal"
                                                   data-bs-target="{{ $yes_modal }}">
                                                   <h5>NO</h5>
                                               </div>
                                           @else
