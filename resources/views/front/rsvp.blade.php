                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                 <div class="rsvp-form">
                                    ...
                                    @php
                                        $i=0;
                                        $firstMatched = false;  // Flag to track if we've already shown the first matching user
                                    @endphp
                                    @foreach ($getInvitedusers['all_invited_users'] as $guest_data )
                                            ...
                                            @endphp
                                                ...
                                                @if (!$firstMatched && $user_id == $guest_data['id'])
                                                        <!-- Show the first matching guest -->
                                                        @if($is_host == "1" || 
                                            ...
                                            @endif<!-- Customize this line to display the user data -->
                                                        @php
                                                            $firstMatched = true;  // Set flag to true after showing the first match
                                                        @endphp
                                                @else
