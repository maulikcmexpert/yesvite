        ...
        <div class="container">
            <div class="rsvp-footer-btn">
                ...
                <div class="d-flex align-items-center justify-content-end gap-3 w-100">
                    <button class="cmn-btn check_rsvp_yes" data-sync_id="{{encrypt($sync_contact_user_id)}}" data-event_id="{{encrypt($event_id)}}" data-user_id="{{encrypt($user_id)}}" data-bs-toggle="modal" data-bs-target="#rsvp-yes-modal">Yes</button>
    ...
    <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('rsvp.store') }}" id="rsvpYesForm">
                        ...
                        <input type="hidden" value="{{encrypt($sync_contact_user_id)}}" name="sync_id" id="sync_id"/>
