                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-form">
                                                    ...
                                                    <input type="email" name="email" id="email" 
                                                        ...
                                                        @if($sync_contact_user_id != '' && ($user_id == '' || $user_id == null) && $email == '') readonly @endif>
                    ...
                    <div class="guest-user-box">
                        ...
                        <div class="w-100">
                            ...
                            @elseif($user_id==$guest_data['id'])
                                        ...
                                        @endif
                                        @elseif($rsvp_status!="" && empty($user_id) && !empty($sync_contact_user_id) && $sync_contact_user_id == $guest_data['id'])                                        @if($guest_data['rsvp_status']=="1")
                                        <div class="sucess-yes"  data-bs-toggle="modal" data-bs-target="{{$no_modal}}">
                                        <h5 class="green">RSVP'd YES</h5>
                                        <div class="sucesss-cat ms-auto">
                                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
