                                         ...
                                         <div class="accordion rsvp-calender-accordion" id="accordionExample">
                                            ...
                                            <div class="mx-auto adsense-center" style="text-align: center;">  
                                                @if((isset($display_ad)&& $display_ad==true))
                                                    ...
                                                    data-ad-slot="7204833835" data-full-width-responsive="true"></ins>
                                                <script>
                                            const adElement = document.getElementById('my-ad');
                                            ...
                                            <div class="rsvp-footer-btn">
                                                ...
                                                <a href="javascript:void(0)" class="close_rsvp_footer">
                                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M1.16748 1.1665L12.8334 12.8324" stroke="#E2E8F0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                        <path d="M1.16664 12.8324L12.8325 1.1665" stroke="#E2E8F0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    </svg>
                                                </a>
                                            </div>
                                        </div>
