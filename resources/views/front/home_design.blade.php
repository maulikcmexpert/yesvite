            ...
            @foreach ($categories as $category)
                ...
                @if ($firstTextData)
                    <div id="design_category"
                        class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6 mt-xl-4 mt-sm-4 mt-4 wow fadeInDown image-item all_designs"
                ...
                @foreach ($category->subcategory as $subcategory)
                    @foreach ($subcategory->textdatas as $image)
                        <div style="display: none"
                            class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6 mt-xl-4 mt-sm-4 mt-4 wow fadeInDown image-item-new all_designs"
