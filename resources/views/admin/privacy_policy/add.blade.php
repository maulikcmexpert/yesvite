    ...
    <div class="col-md-12">
        <div class="card card-primary categoryCard">
            <div class="card-header">
                <h3 class="card-title">{{ $privacyPolicies->isEmpty() ? 'Add Privacy Policy' : 'Edit Privacy Policy' }}</h3>
            </div>

            <form method="post" action="{{ route('privacy_policy.store') }}" id="categoryForm">
                @csrf
