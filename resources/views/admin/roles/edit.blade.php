                ...
                <div class="card-body row" id="appendHtml">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="phone_number" placeholder="Enter Phone Number" value="{{$get_role_data->phone_number}}"  oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="15">
