                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                        ...
                                        <div class="product-images demo-gallery">
                                            ...
                                            <div class="main-img-slider">
                                                ...
                                                <a data-fancybox="gallery"
                                                    href="{{ asset('public/storage/post_image/'.$postImg->post_image)}}"><img
                                                        src="{{ asset('public/storage/post_image/'.$postImg->post_image)}}" /></a>
                                                @endforeach
                                            </div>
                                                        ...
                                                        <label for="choice-1">
                                                            ...
                                                            <div class="progress">
                                                                <div class="progress-bar"
                                                                    style="width: <?= round(getOptionTotalVote($optionVal->id) * 100 / getTotalEventInvitedUser($postVal->event_id)); ?>%">
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-12">
                                    <div class="aWrap"
                                        data-src="{{ asset('public/storage/event_post_recording/'.$postVal->post_recording)}}">
                                    ...
                                    <div class="event_posts_right">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="#" type="button" data-toggle="modal"
                                                        data-target="#like-modal">
                                                        <i class="fa fa-heart"
                                                            aria-hidden="true"></i>{{$postVal->event_post_reaction_count}}
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#" type="button" data-toggle="modal"
                                                        ...
                                                        <i class="fa fa-comment"
                                                            aria-hidden="true"></i>{{$postVal->event_post_comment_count}}
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="event_posts_creator">
                                            <div class="event_posts_creator_img">
                                                <img src="{{ asset('public/storage/profile/'.$postVal->user->profile)}}"
...
<!-- The Like-Modal -->
<div class="modal like-popup-modal" id="like-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="like-wrapper-main">

                    <li>
                        <div class="like-wrapper-left">
                            <div class="like-wrapper-icon">
                                <img src="https://yesvite.cmexpertiseinfotech.in/public/storage/profile/1703076293_1826239546.jpeg"
                                    alt="placeholder image">
                            </div>
                            <div class="like-wrapper-content">
                                <h6>Maulik Nagar</h6>
                            </div>
                        </div>
...
<!-- The Comment-Modal -->
<div class="modal like-popup-modal comment-popup-modal" id="comment-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="modal-save-btn">Save Changes</button>
            </div>
