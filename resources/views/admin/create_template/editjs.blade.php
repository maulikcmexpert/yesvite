                    ...
                    if (data) {
                        ...
                        if (data.static_information) {
                            ...
                            fabric.Object.prototype.controls.mtr = new fabric.Control({
                                ...
                                offsetY: -40, // Adjust the position of the icon relative to the object
                                cursorStyle: 'pointer',
                                actionHandler: fabric.controlsUtils.rotationWithSnapping, // Rotation functionality
                                actionName: 'rotate',
...
`; // Your icon URL or base64 data URI
                                    ctx.drawImage(img, left - size / 2, top - size / 2, size, size); // Draw the icon on the rotation point
                                    ctx.restore();
                                }
                            });
