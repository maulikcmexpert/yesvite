<script type="text/javascript">
            ...
            function loadTextDataFromDatabase() {
                ...
                fetch(`/loadTextData/${id}`) // API endpoint to load data from your database
                    ...
                    .then((data) => {
                            if (data) {
                                ...
                                if (data.static_information) {
                                    ...
                                    staticInfo.textElements.forEach((element) => {
                                        ...
                                        ===
                                        =
                                        addIconsToTextbox(textElement); canvas.add(textElement); console.log(textElement); canvas.renderAll(); // Ensure the canvas is updated after adding text
                                    }
                                });
                        } else {
                            showStaticTextElements();
                            ...
                            addDraggableText(150, 350, "Location", "fdf"); >>>
                            >>>
                            > 674 f84c6950396c01be1c3b2589a744d0b4eb21d
                        }
    ...
    function addEditableTextbox(left, top, textContent) {
        ...
        textbox.on("scaling", function() {
            ...
            var updatedFontSize =
                (textbox.fontSize * (textbox.scaleX + textbox.scaleY)) / 2;
    ...
    function saveTextDataToDatabase() {
        ...
        var csrfToken = document
            ...
            .getAttribute("content"); // Get CSRF token
        var canvasElement = document.getElementById("imageEditor1");
    ...
    document
        .getElementById("Bungee-RegularButton")
        .addEventListener("click", function() {
            console.log("fontname");
