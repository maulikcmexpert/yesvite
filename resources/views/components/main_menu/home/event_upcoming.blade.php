            ...
            <div class="home-upcoming-events-card-left-foot">
                ...
                <div class="dropdown upcoming-card-dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <a class="dropdown-item event_event_duplicate_option" href="#">
                        <svg  viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                      <a class="dropdown-item event_event_cancel_option" id="cancel_event_option" data-event_id="{{$events['id']}}" type="button" data-bs-toggle="modal" data-bs-target="#cancelevent">
                        <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
