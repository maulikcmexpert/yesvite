...
<div class="home-center-upcoming-events-wrp">
    ...
    <div class="home-center-upcoming-events-card mb-3"  style="cursor: pointer;">
            ...
            <div class="home-upcoming-events-card-left-foot">
                ...
                <div class="dropdown upcoming-card-dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a class="dropdown-item event_edit_option" href="{{ route('event', encrypt($events['id'])) }}">
                    ...
                    @if($events['is_event_owner']==1)
                      <li>
                        <a class="dropdown-item event_event_duplicate_option" href="{{ route('event', ['id' => encrypt($events['id']), 'iscopy' => 1]) }}">
                          <svg  viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="" class="home-upcoming-events-card-right zoom_img">
