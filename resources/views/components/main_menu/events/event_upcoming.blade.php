...
<div class="tab-pane fade active show" id="nav-upcoming" role="tabpanel" aria-labelledby="nav-upcoming-tab">
    ...
    <div class="all-events-month-wise-wrp" >
      ...
      <div class="all-events-month-wise-inner" id="scrollStatus">
        ...
        @foreach ( $eventList as $key=>$upcomingEvent)
            ...
            $colorIndex++;
            $eventRoute = ($upcomingEvent['event_wall'] == "0" &&($upcomingEvent['is_event_owner'] == 1 || $upcomingEvent['is_co_host'] == "1"))
    ...
    : route('event.event_wall', encrypt($upcomingEvent['id']));
            ...
            <div class="all-events-month-wise-support upcoming_event_{{$upcomingEvent['id']}}" data-month="{{$upcomingEvent['event_month']}}">
                            ...
                            <div class="d-flex align-items-center gap-4">
                                ...
                                <button class="dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <ul class="upcoming-events-card-notification-info dropdown-menu">
                                        <li><button class="notification-btn" data-status="1" data-is_owner="{{$upcomingEvent['is_event_owner']}}" data-user_id="{{$upcomingEvent['self_id']}}" data-event_id="{{$upcomingEvent['id']}}"><i class="fa-regular fa-bell"></i> Silence Notifications</button></li>
                                    </ul>
                                    @else
                                    <ul class="upcoming-events-card-notification-info dropdown-menu">
                                        <li><button class="notification-btn" data-status="0" data-is_owner="{{$upcomingEvent['is_event_owner']}}" data-user_id="{{$upcomingEvent['self_id']}}" data-event_id="{{$upcomingEvent['id']}}"><i class="fa-regular fa-bell-slash"></i> Enable Notifications</button></li>
                                    </ul>
                                    @endif
                                </div>
                                ...
                                <div class="dropdown upcoming-card-dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                        <a class="dropdown-item" href="{{ route('event', encrypt($upcomingEvent['id'])) }}">
                                            <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="{{ route('event', ['id' => encrypt($upcomingEvent['id']), 'iscopy' => 1]) }}">
                ...
                @if($month_change !=$upcomingEvent['event_month'])
                    <h6 class="all-events-inner-month-show">{{$upcomingEvent['event_month']}}</h6>
                    @php
                        $month_change = $upcomingEvent['event_month'];
                    @endphp
                    <input type="hidden" class="latest_month" value="{{$month_change}}"/>
                @endif
