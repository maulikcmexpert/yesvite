                            ...
                            <div class="d-flex align-items-center gap-4">
                                ...
                                <div class="dropdown upcoming-card-dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                        <a class="dropdown-item" href="{{ route('event', $upcomingEvent['id']) }}">
                                            <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <li>
                                        <button class="dropdown-item cancel_event_option" data-event_id="{{$upcomingEvent['id']}}" type="button" data-bs-toggle="modal" data-bs-target="#cancelevent">
                                            <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
