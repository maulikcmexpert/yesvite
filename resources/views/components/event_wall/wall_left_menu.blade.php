    ...
    <div class="hosted-by-title">
        ...
        <div class="dropdown hosted-by-title-dropdown">
            ...
            <ul class="dropdown-menu">
                  <li>
                    <a class="dropdown-item" href="{{ route('event', encrypt($eventDetails['id'])) }}">
                  ...
                  <li>
                    <button class="dropdown-item cancel_event_option" data-isWall="1" id="cancel_event_option" data-event_id="{{$eventDetails['id']}}" type="button" data-bs-toggle="modal" data-bs-target="#cancelevent">
        ...
        <div class="swiper mySwiper">
            ...
            <div class="swiper-button-next">
                <svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.49984 16.9201L1.97984 10.4001C1.20984 9.63008 1.20984 8.37008 1.97984 7.60008L8.49984 1.08008" stroke="#64748B" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                </svg>
            </div>
            <div class="swiper-button-prev">
                <svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.41016 16.9201L7.93016 10.4001C8.70016 9.63008 8.70016 8.37008 7.93016 7.60008L1.41016 1.08008" stroke="#64748B" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                </svg>
            </div>
