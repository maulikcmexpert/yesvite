...
<div class="main-content-left">
    <div class="hosted-by-title">
        ...
        @if($eventDetails['is_event_owner']==1 || $eventDetails['is_co_host']=="1")
        <div class="dropdown hosted-by-title-dropdown">
            ...
            <ul class="dropdown-menu">
                  ...
                  <li>
                    <button class="dropdown-item cancel_event_option" id="cancel_event_option" data-event_id="{{$eventDetails['id']}}" type="button" data-bs-toggle="modal" data-bs-target="#cancelevent">
