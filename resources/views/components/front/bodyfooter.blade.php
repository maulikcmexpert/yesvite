      ...
      <div class="container-fluid">
          <div class="footer-content d-flex justify-content-between">
              ...
              <ul class="nav">
                  ...
                  <li class="nav-item">
                      <a class="nav-link"
                          href="https://docs.google.com/forms/d/e/1FAIpQLSdj1Jt0MmugCJ5OCh8j6ITod6o_ERI5vm4kJup0PWtDeAemTA/viewform?usp=dialog">Help
                          Center</a>
                  </li>
                  {{-- <li class="nav-item">
          ...
          <div class="footer-bottom d-flex justify-content-between flex-wrap">
              <ul class="footer-social-link">
                  ...
                  @if (isset($getSocialLink->x_link) && $getSocialLink->x_link != null)
                      <li>
                          ...
                          <a
                              href="{{ isset($getSocialLink->x_link) && $getSocialLink->x_link != null ? $getSocialLink->x_link : '#' }}">

                              <span>
                                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                      xmlns="http://www.w3.org/2000/svg">
                                      <path
                                          d="M18.901 1.15381H22.581L14.541 10.3438L24 22.8468H16.594L10.794 15.2628L4.156 22.8468H0.474L9.074 13.0168L0 1.15481H7.594L12.837 8.08681L18.901 1.15381ZM17.61 20.6448H19.649L6.486 3.24081H4.298L17.61 20.6448Z"
                                          fill="black" />
                                  </svg>
                              </span>
                          </a>
                  ...
                  @if (isset($getSocialLink->facebook_link) && $getSocialLink->facebook_link != null)
                      <li>
                          ...
                          <a
                              href="{{ isset($getSocialLink->facebook_link) && $getSocialLink->facebook_link != null ? $getSocialLink->facebook_link : '#' }}">
                              <span>
                                  <svg width="14" height="24" viewBox="0 0 14 24" fill="none"
                                      xmlns="http://www.w3.org/2000/svg">
                                      <path
                                          d="M9.34922 13.8015H12.3492L13.5492 9.00146H9.34922V6.60147C9.34922 5.36547 9.34922 4.20147 11.7492 4.20147H13.5492V0.169465C13.158 0.117865 11.6808 0.00146484 10.1208 0.00146484C6.86282 0.00146484 4.54922 1.98986 4.54922 5.64146V9.00146H0.949219V13.8015H4.54922V24.0015H9.34922V13.8015Z"
                                          fill="#1877F2" />
                                  </svg>
                              </span>
                          </a>
                                      ...
                                      <defs>
                                          ...
                                          <clipPath id="clip0_3391_343">
                                              <rect width="24" height="24" fill="white"
                                                  transform="translate(0.5 0.00146484)" />
                                          </clipPath>
                                      </defs>
                                  </svg>
                              </span>
              ...
              <div class="app-store d-flex gap-2">
                  ...
                  <a href="{{ isset($getSocialLink->playstore_link) && $getSocialLink->playstore_link != null ? $getSocialLink->playstore_link : '#' }}"
                      class="google-app" target="_blank">
                  ...
                  <a href="{{ isset($getSocialLink->appstore_link) && $getSocialLink->appstore_link != null ? $getSocialLink->appstore_link : '#' }}"
                      class="mobile-app" target="_blank">
