...
<div class="modal fade cmn-modal about-rsvp" id="rsvp_by_notification" tabindex="-1"
    aria-labelledby="rsvp_by_notificationLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="rsvp-custom-radio guest-rsvp-attend">
                        ...
                        <div class="rsvp-input-form">
                            ...
                            <div class="input-form rsvp-no-checkbox">
                                ...
                                <label for="rsvp_no"><svg class="me-2" width="21" height="20"
                        ...
                        <div class="rsvp-guest-count">
                            <div>
                                ...
                                <div class="qty-container ms-auto">
                                    <button class="qty-btn-minus rsvp_minus_notify" type="button"><i
                                            class="fa fa-minus"></i></button>
                                    <input type="number" name="rsvp_notification_adult" id="rsvp_notification_adult"
                                        class="input-qty" readonly>
                                    <button class="qty-btn-plus rsvp_plus_notify" type="button"><i
                            ...
                            <div>
                                ...
                                <div class="qty-container ms-auto">
                                    <button class="qty-btn-minus rsvp_minus_notify" type="button"><i
                                            class="fa fa-minus"></i></button>
                                    <input type="number" name="rsvp_notification_kids" id="rsvp_notification_kids"
                                        class="input-qty" readonly>
                                    <button class="qty-btn-plus rsvp_plus_notify" type="button"><i
                                            class="fa fa-plus"></i></button>
                                </div>
                    ...
                    <div class="rsvp-msgbox">
                        ...
                        <div class="input-form">
                            <textarea name="rsvp_notification_message" id="rsvp_notification_message" class="form-control inputText"
                                id="Fname" name="Fname" required=""></textarea>
...
@if (isset($prices) && count($prices) > 0)
    ...
    <button type="button" data-bs-toggle="modal" data-bs-target="#buycreditsmodal"
        class="buynow d-none">buycreditsmodal</button>
    <div class="modal fade cmn-modal buycreditsmodal" id="buycreditsmodal" tabindex="-1"
                    ...
                    <div class="reactions-info-main event-center-tabs-main">
                        ...
                        <nav>
                            <div class="nav nav-tabs reaction-nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link active" id="nav-bulk-credit-options-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-bulk-credit-options" type="button" role="tab"
                                    aria-controls="nav-bulk-credit-options" aria-selected="true">
                                    Bulk Credit Options
                                </button>
                                <button class="nav-link" id="nav-credit-feature-details-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-credit-feature-details" type="button" role="tab"
                                    aria-controls="nav-credit-feature-details" aria-selected="false" tabindex="-1">
                                    Feature Details
                                </button>
                            </div>
                        </nav>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade active show" id="nav-bulk-credit-options" role="tabpanel"
                                aria-labelledby="nav-bulk-credit-options-tab">
                                                ...
                                                @if (!$loop->last)
                                                    <li class="best-deal-item">
                                                        <div class="bulk-credit-options-listing-left">
                                                            <h3>
                                                                <span><img src="{{ asset('assets') }}/coin.svg"
                                                                        alt=""></span>
                                                                {{ $price['coins'] }} Credits
                                                            </h3>
                                                            <p>${{ number_format($price['price'] / $price['coins'], 2) }}
                                                                per credit</p>
                                                        </div>
                                                        <div class="bulk-credit-options-listing-right">
                                                            <h4>${{ number_format($price['price'], 2) }}</h4>
                                                            <div class="form-check">
                                                                <input class="form-check-input price-option"
                                                                    type="radio" name="priceId"
                            ...
                            <div class="tab-pane fade" id="nav-credit-feature-details" role="tabpanel"
                                aria-labelledby="nav-credit-feature-details-tab">
                                <div class="credit-feature-details-wrp">
                                    <div class="credit-feature-details-note">
                                        <p>Straightforward transparent prices. All features included. No hidden costs or
                                            gimmicks.</p>
                                    </div>
                                    <div class="bulk-credit-options-head">
                                        <h5>1 Credit = 1 Invite</h5>
                                    ...
                                    <ul class="credit-feature-details-listing">
                                        <li><span><i class="fa-solid fa-circle-check"></i></span>No monthly/yearly
                                            subscriptions</li>
                                        <li><span><i class="fa-solid fa-circle-check"></i></span>No gimmicky extra fees
                                        </li>
                                        <li><span><i class="fa-solid fa-circle-check"></i></span>No Ads</li>
                                        <li><span><i class="fa-solid fa-circle-check"></i></span>Set a schedule for
                                            event activities </li>
                                        <li><span><i class="fa-solid fa-circle-check"></i></span>Create Potluck </li>
                                        <li><span><i class="fa-solid fa-circle-check"></i></span>Guests can leave video
                                            RSVP’s</li>
                                        <li><span><i class="fa-solid fa-circle-check"></i></span>Guest polls on event
                                            wall</li>
                                        <li><span><i class="fa-solid fa-circle-check"></i></span>Add a 3 photos slider
                                            with invite </li>
                                        <li><span><i class="fa-solid fa-circle-check"></i></span>Co-host Option</li>
                                        <li><span><i class="fa-solid fa-circle-check"></i></span>Thank you messages
                                            after event</li>
                                        <li><span><i class="fa-solid fa-circle-check"></i></span>Guests can leave you
                                            video RSVP’s</li>
                                        ...
                                        <li><span><i class="fa-solid fa-circle-check"></i></span>Direct message (DM)
                                            guests</li>
                                    </ul>
                                </div>
                            </div>
...
@endif
<div class="modal fade cmn-modal cancel-event cancel_event_mainmenu" id="cancelevent" tabindex="-1"
    aria-labelledby="canceleventLabel">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="delete-modal-head text-center">
                    ...
                    <input type="hidden" id="isWall" />
                    <h4>Cancel Event</h4>
                    <p>Cancelling this event will delete everything in this event including but not limited to all
                        comments, photos, and settings associated with this event for you and your guests.</p>
                </div>
                <div class="guest-msg">
                    <h5>Message to guests</h5>
                    <textarea name="" id="reason_to_cancel_event"
                        placeholder="*Let your guests know why you are cancelling event......."></textarea>
                </div>
            ...
            <div class="modal-footer cancel-confirm-btn">
                ...
                <button type="button" class="btn btn-secondary confirm-btn confirm_cancel_event_btn"
                    id="confirm_cancel_event_btn">Confirm</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="d-flex justify-content-center gap-3 align-items-start">
            <div>
                ...
                <p><b>By using yesvite,you agree to our </b><a
                    href="{{ route('privacy_policy') }}">Privacy Policy</a> and Terms of use. we use your information only to provide and improve our service.
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
    stylesheet.crossOrigin="anonymous"></script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/html-to-image/1.7.0/html-to-image.js"
    integrity="sha512-uIP4HNFMvnpcVpzoE17SkA3zrdBkNZy2G6t65q2m44kDBHd6emnvYOuXxtPdudQOsCMxO0HuhBnYm1ao9GvJWw=="
    crossorigin="anonymous" referrerpolicy="no-referrer"></script>
                        ...
                        fetch("{{ route('payment.checkPay') }}", {
                            ...
                            .then(data => {
                                if (data.status === 'success') {
                                    ...
                                    const coinsSpans = document.querySelectorAll(
                                        '.available-coins');
                                    const coinsInputs = document.querySelectorAll(
                                        '.hidden-coins');
