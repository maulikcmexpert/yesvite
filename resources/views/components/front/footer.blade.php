                    ...
                    <div class="rsvp-guest-count">
                      <div>
                        ...
                        <div class="qty-container ms-auto">
                          ...
                          <input type="number" name="rsvp_notification_adult" id="rsvp_notification_adult"  class="input-qty" readonly>
                      ...
                      <div>
                        ...
                        <div class="qty-container ms-auto">
                          <button class="qty-btn-minus rsvp_minus_notify" type="button"><i class="fa fa-minus"></i></button>
                          <input type="number" name="rsvp_notification_kids" id="rsvp_notification_kids"  class="input-qty" readonly>
                          <button class="qty-btn-plus rsvp_plus_notify" type="button"><i class="fa fa-plus"></i></button>
                        </div>
                      </div>
                    </div>
...
<script src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1693502653295820"
  ></script>
