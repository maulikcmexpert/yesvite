                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdownNotification-menu" aria-labelledby="dropdownNotification-menu">
                    <li><a href="{{route('account_settings.notificationSetting')}}"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M11.6665 1.66699H7.49984C3.33317 1.66699 1.6665 3.33366 1.6665 7.50033V12.5003C1.6665 16.667 3.33317 18.3337 7.49984 18.3337H12.4998C16.6665 18.3337 18.3332 16.667 18.3332 12.5003V8.33366" stroke="#94A3B8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
                                    ...
                                    <div class="notification-drodown-body-inner-content">
                                      <div>
                                        <h3>
                                          ...
                                          <span> will bring the item below for <a href="{{ route('event.event_about', ['id' => encrypt($inner_data['event_id'])]) }}"   style="font-family: var(--SFProDisplay-Bold);font-size: 14px;line-height:normal;color: #F73C71;">{{$inner_data['event_name']}} </a>
                                          </span>
                                        </h3>
                                        <div>
                                          <h6 class="notification-time-count">{{$inner_data['post_time']}}</h6>
                                  ...
                                  <div class="notification-drodown-body-inner">
                                    ...
                                    >
                                      <div>
                                        <h3>
                                          {{$inner_data['first_name']}} {{$inner_data['last_name']}}
                                          <span> commented on your post on <a href="{{ route('event.event_about', ['id' => encrypt($inner_data['event_id'])]) }}"   style="font-family: var(--SFProDisplay-Bold);font-size: 14px;line-height:normal;color: #F73C71;">{{$inner_data['event_name']}} </a></span>
                                        </h3>
                                        <h6 class="notification-time-count">{{$inner_data['post_time']}}</h6>
                                      </div>
                                      <div>
                                    ...
                                    <div>
                                      <h3>
                                        ...
                                        @if($inner_data['media_type']=="photo")
                                            ...
                                            <span> posted new photo on wall for <a href="{{ route('event.event_wall', ['id' => encrypt($inner_data['event_id'])]) }}#scroll_{{ $inner_data['post_id'] }}"   style="font-family: var(--SFProDisplay-Bold);font-size: 14px;line-height:normal;color: #F73C71;">{{$inner_data['event_name']}} </a> </span>
                                        @elseif($inner_data['media_type']=="video")
                                          ...
                                          <span> posted video on wall for <a href="{{ route('event.event_wall', ['id' => encrypt($inner_data['event_id'])]) }}#scroll_{{ $inner_data['post_id'] }}"   style="font-family: var(--SFProDisplay-Bold);font-size: 14px;line-height:normal;color: #F73C71;">{{$inner_data['event_name']}} </a><strong></strong></span>
                                        @else
                            ...
                            @elseif($inner_data['notification_type']=="sent_rsvp" && $inner_data['rsvp_detail']['rsvpd_status']=="1" )
                              <div class="notification-drodown-body-inner">
                                ...
                                <div class="notification-drodown-body-inner-content">
                                  ...
                                  <div>
                                    <p>
                                      <a href="{{ route('event.event_about', ['id' => encrypt($inner_data['event_id'])]) }}"   style="font-family: var(--SFProDisplay-Bold);font-size: 14px;line-height:normal;color: #F73C71;">{{$inner_data['event_name']}}</a>
                                      <!-- <span><strong>Wall</strong></span> -->
                                    </p>
                                    @if($inner_data['read']=="0")
                                            <h6 class="notification-read-dot"></h6>
                                    ...
                                    <div class="notification-drodown-body-inner-content">
                                      <div>
                                        ...
                                        <h3>
                                          {{-- {{$inner_data['notification_message']}} --}}
                                          {{$inner_data['first_name']}} {{$inner_data['last_name']}}
                                          <span> posted new photo on photos for <a href="{{ route('event.event_about', ['id' => encrypt($inner_data['event_id'])]) }}"   style="font-family: var(--SFProDisplay-Bold);font-size: 14px;line-height:normal;color: #F73C71;">{{$inner_data['event_name']}} </a></span>
                                        </h3>
                                        <h6 class="notification-time-count">{{$inner_data['post_time']}}</h6>
                                      </div>
                                    <div>
                                  ...
                                  <div class="notification-drodown-body-inner">
                                    ...
                                    >
                                      <div>
                                        <h3>
                                          {{$inner_data['first_name']}} {{$inner_data['last_name']}}
                                          <span> Accepted your invitation to co-host <a href="{{ route('event.event_about', ['id' => encrypt($inner_data['event_id'])]) }}"   style="font-family: var(--SFProDisplay-Bold);font-size: 14px;line-height:normal;color: #F73C71;">{{$inner_data['event_name']}} </a></span>
                                        </h3>
                                        <h6 class="notification-time-count">{{$inner_data['post_time']}}</h6>
                                      </div>
                                      <div>
              ...
              <form action="" id="event_filter">
                  <div class="notification-filter-sub event-search-filter">
                    ...
                    @foreach ($data as $event )
                        ...
                        @endphp
                    <div class="form-check">
                      <input class="form-check-input selectedEvents" name="selectedEvents[]" data-event_name="{{$event['event_name']}}"data-event_id="{{$event['id']}}" type="checkbox" value="" id="flexCheckDefault{{$j}}">
