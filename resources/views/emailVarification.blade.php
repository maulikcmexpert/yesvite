    ...
    <div class="verify-wrapper">
        <div class="container">
            <div class="verify-content">
                ...
                <p>{{$message}}</p>
                <a href="{{route('ResendVerificationMail',43)}}" class="email-login-btn-wrp" id="requestEmail"><button type="button" class="email-login-btn">Request Another Email</button></a>
