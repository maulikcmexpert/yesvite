            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size: 16px;line-height: 25px;font-weight: 400;color: #0F172A ;margin: 0px 0px;font-family: 'SF Pro Display'">
                        ...
                        <p>Person being Reported name : {{isset($userdata['reported_username'])?$userdata['reported_username']:""}}</p>
                        <p>Person being Reported email Address : {{isset($userdata['reported_email'])?$userdata['reported_email']:""}}</p>
