...
<body
    ...
    <div style="width: 100%;max-width: 650px;height:100%;padding: 0px 10px;margin: 50px 0px" class="ui-sortable">
        <table
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <h4 style="font-size: 20px;line-height: 28px;font-weight: 700;color: #0F172A;margin: 0px 0px;">
                            Your invites have been successfully sent</h4>
                    </td>
                </tr>
                <!-- -------------- -->
                <tr>
                ...
                <tr>
                    <td>
                        <h2 style="font-size: 32px;line-height: 44px;font-weight: 700;color: #0A090B;margin: 0px 0px;">
                            {{$eventData['event_name']}}</h2>
                        <p style="font-size: 16px;line-height: 27px;font-weight: 400;color: #0F172A;margin: 10px 0px;">
                ...
                <tr>
                    <td>
                        <div class="invited-img"
                            style="width: 100%;max-width: 300px;height: 430px;border-radius: 10px;margin-top: 15px;border: 1px solid lightgray;">
                            <img src="{{ asset('public/storage/event_images/'.$eventData['event_image'])}}" alt=""
                ...
                <tr>
                    {{-- <td>
                        <div class="view-btn" style="display: flex;align-items: center;gap: 15px;">
                            <a href="{{route('rsvp', ['userId' => encrypt($eventData['owner_id']), 'eventId' => encrypt($eventData['event_id'])])}}"
                    style="font-family: 'SF Pro Display', sans-serif;font-size: 14px;line-height: 20px;font-weight:
                    500;color: #fff;background: #F73C71;border: 1px solid #F73C71;border-radius: 10px; padding: 10px
                    24px 10px 24px;width: 100%;max-width: 250px;text-transform: capitalize;">View Invitation</a>
    </div>
    </td> --}}
    <td>
        @php
        $eventLink = route('rsvp', ['event_invited_user_id' => encrypt($eventData['event_invited_user_id']),'eventId' =>
        encrypt($eventData['event_id'])]);
        $shortLink = createShortUrl($eventLink);
        @endphp
        <div class="view-btn mt-0" id="view-btn" style="display:inline;width: 100%;">
            <a href="{{$shortLink}}"
                style="font-family: 'SF Pro Display', sans-serif; margin-right:10px; font-size: 14px;line-height: 20px;font-weight: 500;color: #fff;background: #F73C71;border: 1px solid #F73C71;border-radius: 10px; padding: 10px 24px 10px 24px; text-align:center;text-decoration:none"
                class="view-btn-link">View Invitation</a>
        </div>
    ...
    <tr>
        <td>
            <p style="font-family:'Manrope';font-size: 12px;line-height: 20px;font-weight: 500;color: #0F172A;">Please
                add <a href=""
                    style="color: #0F172A;font-size: 12px;line-height: 20px;font-weight: 700;">notifications@yesvite.com</a>
                to your contacts so the email does not go to your SPAM folder.</p>
            <p style="font-family:'Manrope';font-size: 12px;line-height: 20px;font-weight: 500;color: #0F172A;">If you
                don’t want to receive these notifications please update your <a href=""
                    style="color: #F73C71;font-weight: 700;text-transform: capitalize;">account settings
                    >Notifications.</a></p>
            <p style="font-family:'Manrope';font-size: 12px;line-height: 20px;font-weight: 500;color: #0F172A;">You have
                received this email from <a href=""
                    style="color: #F73C71;font-weight: 700;">notifications@yesvite.com</a> on behalf of <a href=""
        ...
        <td>
            <div class="social-icons" style="display: flex;align-items: center;justify-content: space-between;">
                <div style="width: 100%;max-width: 95px;height: 50px;"><img
                        src="{{ asset('public/storage/yesvitelogo.png')}}" alt="" style="width: 100%;height: 100%;">
                </div>
                <ul style="display: flex;align-items: center;gap: 10px;margin: 0px 0px;">
                    <li style="list-style-type: none;"><a href=""
                            style="color: #475569;width: 100%;max-width: 16px;height: 16px;"><i
                    ...
                    <li style="list-style-type: none;"><a href=""
                            style="color: #475569;width: 100%;max-width: 16px;height: 16px;"><i
                                class="fa-brands fa-apple" style="font-size: 18px;"></i></a></li>
                </ul>
            </div>
        </td>
    </tr>
