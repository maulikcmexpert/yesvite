        ...
        <table style="border-radius: 5px;box-shadow: 0px 0px 2px rgba(0, 0, 0, 0.3);width: 100%;height:100%;background: #fff;box-shadow: 0px 0px 2px rgba(0, 0, 0, 0.3);padding: 30px;border-radius: 20px;" class="full selected-table" border="0" cellpadding="0" cellspacing="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @php
                               $eventLink=route('event.event_about', ['id' => encrypt($eventData['event_id'])]) ;
                        ...
                        <div class="view-btn mt-0" id="view-btn" style="display:inline;width: 100%;">
                            <a href="{{$eventLink}}" style="font-family: 'SF Pro Display', sans-serif; margin-right:10px; font-size: 14px;line-height: 20px;font-weight: 500;color: #fff;background: #F73C71;border: 1px solid #F73C71;border-radius: 10px; padding: 10px 24px 10px 24px; text-align:center;text-decoration:none" class="view-btn-link">Manage Event</a>
                        </div>
