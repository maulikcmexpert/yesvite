                ...
                <tr>
                    <td>
                        <h4 style="font-size: 20px;line-height: 28px;font-weight: 700;color: #0F172A;margin: 0px 0px;">
                            {{$userdata['send_by']}} <span
                                style="font-size: 20px;line-height: 28px;font-weight: 500;color: #0F172A;margin: 0px 0px;">sent
                                you a private message via Yesvite</span></h4>
                    </td>
                </tr>
                <!-- -------------- -->
                <tr>
                ...
                <tr>
                    <td>
                        <div class="view-btn" style="display: flex;align-items: center; gap: 15px;">
                            <a href="{{route('message.list')}}"><button
                                    style="font-family: 'SF Pro Display', sans-serif;font-size: 14px;line-height: 20px;font-weight: 500;color: #fff;background: #F73C71;border: 1px solid #F73C71;border-radius: 10px; padding: 10px 24px 10px 24px; margin-right: 15px;">View
                                    Message</button></a>
                            {{-- <button style="font-family: 'SF Pro Display', sans-serif;font-size: 14px;line-height: 20px;font-weight: 500;color: #0F172A;background: transparent;border: 1px solid #E2E8F0;border-radius: 10px; padding: 10px 24px 10px 24px;">View {{$userdata['send_by']}}'s
                            Profile</button> --}}
                        </div>
                    </td>
                </tr>
                    ...
                    <td>
                        ...
                        <p
                            ...
                            You have received this email from <a href=""
                                ...
                                href="" style="color: #F73C71;font-weight: 700;">ekuanox@gmail.com</a>.</p>
                        <p
                            style="font-family:'Manrope';font-size: 12px;line-height: 20px;font-weight: 500;color: #0F172A;">
                            © Yesvite 2024</p>
                    </td>
                ...
                <tr>
                    <td>
                        <p
                            ...
                            Invitee Email: <a href="mailto:crisilis@hotmail.com"
                                style="font-family:'Manrope';font-size: 12px;line-height: 20px;font-weight: 500;color: #0F172A;">crisilis@hotmail.com</a>
                        </p>
                    </td>
                </tr>
                <!-- -------------- -->
