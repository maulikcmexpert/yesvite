        ...
        <tr>
            <td>
                <table style="border-radius: 10px;background: #FFF; width: 100% ;max-width: 600px; box-shadow: 0px 7px 21px 0px rgba(30, 36, 82, 0.05);padding-top: 39px; padding-left: 30px; padding-right: 30px; display: block;padding-bottom: 100px;">
                    <tbody>
                        <tr>
                            <td style="color: #000; font-family: 'Poppins-Regular'; font-size: 25px; text-align: center; line-height: 28px; padding-bottom: 25px;">
                                Your OTP
                            </td>
                        </tr>
                        <tr>
                            <td style="color: #E73080; text-align: center; font-family: 'Poppins-Regular'; font-size: 20px; line-height: 28px; padding-bottom: 25px;">
                                Hello {{$userData[0]['username']}},
                            </td>
                        </tr>
                        <tr>
                            <td style="color: #606271; font-family: 'Poppins-Regular'; font-size: 16px; line-height: 28px; text-align: center;">
                                Thank you for choosing this company. Us the Following OTP to complete the procedure to change your email address. OTP is valid for 5 <strong>minutes</strong>. Do
                                not share this code with others.
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="d-flex justify-content-center" type="button" style="border-radius: 10px;background: #fff; color:#ffffff; box-shadow: 0px 5px 20px 0px rgba(255, 78, 0, 0.20); display:flex; 
