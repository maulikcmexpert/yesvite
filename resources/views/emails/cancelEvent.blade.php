...
<body
    ...
    <div style="width: 100%;max-width: 650px; height:100%; padding: 0px 10px; margin: 50px auto 0px"
        class="ui-sortable">
        <table
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <h4 style="font-size: 32px;line-height: 28px;font-weight: 700;color: #0F172A;margin: 0px 0px;">
                            The event was canceled successfully</h4>
                        @else
                        <h4 style="font-size: 32px;line-height: 28px;font-weight: 700;color: #0F172A;margin: 0px 0px;">
                            The event was unfortunately canceled</h4>
                        @endif
                    </td>
                </tr>
                <!-- -------------- -->
                ...
                <tr>
                    <td>
                        <div class="user-name" style="display: flex;align-items: center;gap: 15px;margin-bottom: 15px;">
                            ...
                            <h3
                                style="text-transform: capitalize;font-size: 32px;line-height: 44px;font-weight: 700;color: #0A090B;margin: 0px 0px;text-transform: capitalize;margin-left: 0px;width:85%; word-wrap:break-word;">
                                {{ @$eventData['hosted_by']}}</h3>
                        </div>
                        ...
                        <p style="font-size: 18px;line-height: 27px;font-weight: 400;color: #0F172A;margin: 10px 0px;">
                ...
                <tr>
                    <td>
                        <div class="invited-img"
                            style="width: 100%;max-width: 300px;height: 430px;border-radius: 10px;border: 1px solid lightgray;">
                ...
                <tr>
                    <td>
                        <p style="font-size: 12px;line-height: 20px;font-weight: 500;color: #0F172A;">Please add <a
                                href=""
                                style="font-size: 12px;line-height: 20px;font-weight: 700;color: #0F172A;">notifications@yesvite.com</a>
                            to your contacts so the email does not go to your SPAM folder.</p>
                        <p style="font-size: 12px;line-height: 20px;font-weight: 500;color: #0F172A;">If you don’t want
                            to receive these notifications please update your <a href=""
                                style="color: #F73C71;font-weight: 700;text-transform: capitalize;">account settings
                                >Notifications.</a></p>
                        <p style="font-size: 12px;line-height: 20px;font-weight: 500;color: #0F172A;">You have received
                            this email from <a href=""
                        ...
                        <p style="font-size: 12px;line-height: 20px;font-weight: 500;color: #0F172A;">© Yesvite
                            {{date('Y')}}</p>
                    </td>
                </tr>
                <!-- -------------- -->
                    ...
                    <td>
                        <div class="download-form-img" style="display: flex;align-items: center;gap: 10px;">
                            <a href="https://play.google.com/store/apps/details?id=com.yesvite.android"
                                style="width: 100%;max-width: 120px;height: 40px;border-radius: 5px;display: block;margin-right: 15px"><img
                ...
                <tr>
                    <td>
                        <p style="font-size: 12px;line-height: 20px;font-weight: 700;color: #0F172A;margin: 0px;">Cancel
                            Event Email: <span
                                style="font-size: 12px;line-height: 20px;font-weight: 500;color: #0F172A;">{{@$eventData['host_email']}}</span>
                        </p>
                    </td>
                </tr>
                <!-- -------------- -->
