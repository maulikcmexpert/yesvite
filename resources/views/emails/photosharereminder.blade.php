                ...
                <tr>
                    <td>
                        <h4 style="font-size: 32px;line-height: 44px;font-weight: 400;color: #0A090B;margin: 0px 0px;">
                            Please share your photos by uploading them via the app for:</h4>
                ...
                <tr>
                    <td>
                        <div class="view-btn" style="display: flex;align-items: center;gap: 15px;">
                            <button
                                style="font-family: 'SF Pro Display', sans-serif;font-size: 14px;line-height: 20px;font-weight: 500;color: #fff;background: #F73C71;border: 1px solid #F73C71;border-radius: 10px; padding: 10px 24px 10px 24px;width: 100%;max-width: 250px;">Upload
                                Photos</button>
                        </div>
                    </td>
                </tr>
