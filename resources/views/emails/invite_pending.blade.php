    ...
    <div style="width: 100%;max-width: 650px;height:100%;padding: 0px 10px;margin: 50px 0px" class="ui-sortable">
        <table style="border-radius: 5px;box-shadow: 0px 0px 2px rgba(0, 0, 0, 0.3);width: 100%;height:100%;background: #fff;box-shadow: 0px 0px 2px rgba(0, 0, 0, 0.3);padding: 30px;border-radius: 20px;" class="full selected-table" border="0" cellpadding="0" cellspacing="0">
            <tbody>
                ...
                <tr>
                    <td>
                        <h4 style="font-size: 20px;line-height: 28px;font-weight: 700;color: #0A090B;margin: 0px 0px;">You have an unfinished event draft.</h4>
                    </td>
                </tr>
                <!-- -------------- -->
                <tr>
                ...
                <tr>
                    <td>
                        <div class="view-btn" style="display: flex;align-items: center;gap: 15px;">
                            <button style="font-family: 'SF Pro Display', sans-serif;font-size: 14px;line-height: 20px;font-weight: 500;color: #fff;background: #F73C71;border: 1px solid #F73C71;border-radius: 10px; padding: 10px 30px 10px 30px;width: 100%;max-width: 250px;text-transform: capitalize;">Complete Invite</button>
                        </div>
                    </td>
                </tr>
                <!-- -------------- -->
