    ...
    <div style="width: 100%;max-width: 650px;height:100%;padding: 0px 10px;margin: 50px 0px" class="ui-sortable">
        <table
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <h4 style="font-size: 20px;line-height: 28px;font-weight: 700;color: #0A090B;margin: 0px 0px;">
                            You have an unfinished event draft.</h4>
                    </td>
                </tr>
                <!-- -------------- -->
                <tr>
                ...
                <tr>
                    <td>
                        <div class="view-btn" style="display: flex;align-items: center;gap: 15px;">
                            <a href="{{ route('event', encrypt($eventData['id'])) }}"
                                style="font-family: 'SF Pro Display', sans-serif;font-size: 14px;line-height: 20px;font-weight: 500;color: #fff;background: #F73C71;border: 1px solid #F73C71;border-radius: 10px; padding: 10px 30px 10px 30px;width: 100%;max-width: 150px;text-transform: capitalize;text-align:center;">Complete
                                Invite</a>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <div class="download-form-img" style="display: flex;align-items: center;gap: 10px;">
                            <a href="#"
                                style="width: 120px;max-width: 120px;height: 40px;border-radius: 5px;display: block;"><img
