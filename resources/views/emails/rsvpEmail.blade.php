                    ...
                    <td>
                        ...
                        ?>
                            ...
                            <div class="invited-persons" style="display: flex;align-items: center; justify-content: space-between; width: 100%;max-width: 250px;background-color: #F0FFE8;border: 1px solid #23AA26;padding: 5px 10px 5px 10px;border-radius: 100px;margin-left: 50px;">
                                ...
                                <div class="persons-right" style="display: flex;align-items: center;gap: 15px; margin-left:auto">
                                    <span class="person-span-1" style="font-size: 10px;line-height: normal;font-weight: 600;color: #0F172A;position: relative; border-right: 2px solid red; padding-right:10px;"><svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        </svg><i class="fa-solid fa-user-group" style="color: #DDE3E0;font-size: 8px;"></i> {{ $eventData['adults'] }} Adults</span>
                        ...
                        <?php } else { ?>
                            ...
                            <div class="invited-persons" style="display: flex;align-items: center;justify-content: space-between; width: 100%;max-width: 250px;background-color: #d9a8a8;border: 1px solid #e52121;padding: 5px 10px 5px 10px;border-radius: 100px;margin-left: 50px;">
                                ...
                                <div class="persons-right" style="display: flex;align-items: center;gap: 15px;margin-left:auto">
                                    <span class="person-span-1" style="font-size: 10px;line-height: normal;font-weight: 600;color: #0F172A;position: relative; border-right: 2px solid gray; padding-right:10px;"><svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3.375 1.60547C2.3925 1.60547 1.59375 2.40422 1.59375 3.38672C1.59375 4.35047 2.3475 5.13047 3.33 5.16422C3.36 5.16047 3.39 5.16047 3.4125 5.16422C3.42 5.16422 3.42375 5.16422 3.43125 5.16422C3.435 5.16422 3.435 5.16422 3.43875 5.16422C4.39875 5.13047 5.1525 4.35047 5.15625 3.38672C5.15625 2.40422 4.3575 1.60547 3.375 1.60547Z" fill="black" fill-opacity="0.2" />
                                            <path d="M5.27938 6.15984C4.23312 5.46234 2.52688 5.46234 1.47312 6.15984C0.996875 6.47859 0.734375 6.90984 0.734375 7.37109C0.734375 7.83234 0.996875 8.25984 1.46938 8.57484C1.99437 8.92734 2.68437 9.10359 3.37437 9.10359C4.06437 9.10359 4.75437 8.92734 5.27938 8.57484C5.75187 8.25609 6.01438 7.82859 6.01438 7.36359C6.01063 6.90234 5.75187 6.47484 5.27938 6.15984Z" fill="black" fill-opacity="0.2" />
                                            <path d="M7.49406 3.6063C7.55406 4.3338 7.03656 4.9713 6.32031 5.05755C6.31656 5.05755 6.31656 5.05755 6.31281 5.05755H6.30156C6.27906 5.05755 6.25656 5.05755 6.23781 5.06505C5.87406 5.0838 5.54031 4.96755 5.28906 4.7538C5.67531 4.4088 5.89656 3.8913 5.85156 3.3288C5.82531 3.02505 5.72031 2.74755 5.56281 2.5113C5.70531 2.44005 5.87031 2.39505 6.03906 2.38005C6.77406 2.3163 7.43031 2.8638 7.49406 3.6063Z" fill="black" fill-opacity="0.2" />
                                            <path d="M8.25 7.07687C8.22 7.44062 7.9875 7.75562 7.5975 7.96937C7.2225 8.17562 6.75 8.27312 6.28125 8.26187C6.55125 8.01812 6.70875 7.71437 6.73875 7.39187C6.77625 6.92687 6.555 6.48062 6.1125 6.12437C5.86125 5.92562 5.56875 5.76812 5.25 5.65187C6.07875 5.41187 7.12125 5.57312 7.7625 6.09062C8.1075 6.36812 8.28375 6.71687 8.25 7.07687Z" fill="black" fill-opacity="0.2" />
                                        </svg> <i class="fa-solid fa-users-line" style="color: #DDE3E0;font-size: 8px;"></i> {{ $eventData['adults'] }} Adults</span>
                                    <span style="font-size: 10px;line-height: normal;font-weight: 600;color: #0F172A; padding-left: 10px">{{ $eventData['kids'] }} Kids</span>
                                </div>
                            </div>
                        <?php }
