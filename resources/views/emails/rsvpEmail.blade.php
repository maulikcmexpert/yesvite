    ...
    <div style="width: 100%;max-width: 650px;margin:0 auto;height:100%; padding: 15px 15px;" class="ui-sortable">
        <table style="border-radius: 5px;box-shadow: 0px 0px 2px rgba(0, 0, 0, 0.3);width: 100%;height:100%;background: #fff;box-shadow: 0px 0px 2px rgba(0, 0, 0, 0.3);padding: 30px;border-radius: 20px;" class="full selected-table" border="0" cellpadding="0" cellspacing="0">
            <tbody>
                ...
                <tr>
                    <td class="view-more fdfd">
                        <div class="view-btn mt-0" id="view-btn" style="display:block;width: 100%;">
                            <a href="#" style="width:100%;display:block; font-family: 'SF Pro Display', sans-serif; margin-right:10px; font-size: 14px;line-height: 20px;font-weight: 500;color: #fff;background: #F73C71;border: 1px solid #F73C71;border-radius: 10px; padding: 10px 24px 10px 24px; text-align:center;" class="view-btn-link">View Invitation</a>
                            <a href="#" style="width:100%;display:block; font-family: 'SF Pro Display', sans-serif;font-size: 14px;line-height: 20px;font-weight: 500;color: #0F172A;background: transparent;border: 1px solid #E2E8F0;border-radius: 10px; padding: 10px 24px 10px 24px; text-align:center;" class="view-btn-link">Message James</a>
                        </div>
                    </td>
                </tr>
                <!-- -------------- -->
