                ...
                <tr>
                    <td>
                        <div style="width: 100%;max-width: 150px;height:65px">
                            <img src="{{ asset('public/storage/yesvitelogo.png')}}" style="width: 100%;max-width: 150px;height:65px; object-fit:cover" alt="logo">
                        </div>
                    </td>
                </tr>
                <!-- -------------- -->
