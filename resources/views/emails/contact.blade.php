...
<body
    style="font-family: 'SF Pro Display', sans-serif !important ;margin: 0px auto;background: #ffffff; display: flex; justify-content: center;  max-width:600px;"
    class="main-center">
    <div style="width: 100%;max-width: 650px;height:100%;padding: 0px 10px;" class="ui-sortable">
        <table
            style="border-radius: 5px;box-shadow: 0px 0px 2px rgba(0, 0, 0, 0.3); width: 100%; margin: 0px auto; max-width:600px; height:100%;background: #fff;box-shadow: 0px 0px 2px rgba(0, 0, 0, 0.3);padding: 30px;border-radius: 20px;"
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <p
                            style="font-family: 'Manrope', sans-serif; font-size: 12px; line-height: 20px; font-weight: 500; color: #0F172A;">
