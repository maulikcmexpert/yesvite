    ...
    <div style="width: 100%;max-width: 650px;height:100%;padding: 0px 10px;" class="ui-sortable">
        <table
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <h4 style="font-size: 32px;line-height: 44px;font-weight: 400;color: #0A090B;margin: 0px 0px;">
                            Are you going?</h4>
                    </td>
                </tr>
                <!-- -------------- -->
                ...
                <tr>
                    <td>
                        <div class="view-btn" style="display: flex;align-items: center;gap: 15px;">
                            <a href="{{ route('rsvp',$eventData['rsvpData'])}}"
                                style="font-family: 'SF Pro Display', sans-serif;font-size: 14px;line-height: 20px;font-weight: 500;color: #fff;background: #F73C71;border: 1px solid #F73C71;border-radius: 10px; padding: 10px 24px 10px 24px;">View
                                Invitation</button>
                                <button
                                    style="font-family: 'SF Pro Display', sans-serif;font-size: 14px;line-height: 20px;font-weight: 500;color: #0F172A;background: transparent;border: 1px solid #E2E8F0;border-radius: 10px; padding: 10px 24px 10px 24px;">Message
                                    Host</button>
                        </div>
                    </td>
                </tr>
                    ...
                    <td>
                        ...
                        <p
                            ...
                            You have received this email from <a href=""
                                ...
                                href="" style="color: #F73C71;font-weight: 700;">{{ @$eventData['host_email'] }}</a>.
                        </p>
                        <p
                            style="font-family:'Manrope';font-size: 12px;line-height: 20px;font-weight: 500;color: #0F172A;">
                            © Yesvite {{date('Y')}}</p>
                ...
                <tr>
                    <td>
                        <div class="social-icons"
                            ...
                            <div style="width: 100%;max-width: 95px;height: 50px;"><img src="./Frame 33827.svg" alt=""
