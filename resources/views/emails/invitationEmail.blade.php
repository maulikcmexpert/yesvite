                ...
                <tr>
                    <td>
                        <div class="download-form-img" style="display: flex;align-items: center;gap: 10px;">
                            <a href="https://drive.google.com/file/d/1_yQ5YEikdw7IMtHS6gZ5mNqP2glVrTNz/view?usp=sharing" style="width: 100%;max-width: 120px;height: 40px;border-radius: 5px;display: block;margin-right: 15px"><img src="{{ asset('public/storage/google-play.png')}}" alt="" style="width: 100%;height: 100%;"></a>
