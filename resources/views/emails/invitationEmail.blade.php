    ...
    <div style="width: 100%;max-width: 650px; height:100%; padding: 0px 10px; margin: 50px auto 0px"
        ...
        <table
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="view-btn mt-0" id="view-btn" style="display:inline;width: 100%;">
                            ...
                            encrypt($eventData['event_invited_user_id']), 'eventId' =>
                ...
                <tr>
                    <td>
                        <p style="font-size: 12px;line-height: 20px;font-weight: 700;color: #0F172A;margin: 0px;">Invite
                            Email: <span
