                ...
                <tr>
                    <td>
                        <h4 style="font-size: 20px;line-height: 28px;font-weight: 700;color: #0F172A;margin: 0px 0px;">
                            Thanks for joining us!! . <span style="font-weight: 400;"> Really enjoyed having you guys
                                over for the party!</span></h4>
                    </td>
                </tr>
                <!-- -------------- -->
                <tr>
                ...
                <tr>
                    <td>
                        <div class="view-btn" style="display: flex;align-items: center;gap: 15px;">
                            <button
                                style="font-family: 'SF Pro Display', sans-serif;font-size: 14px;line-height: 20px;font-weight: 500;color: #0F172A;background: transparent;border: 1px solid #E2E8F0;border-radius: 10px; padding: 10px 24px 10px 24px;width: 100%;max-width: 300px;">Message
                                Host</button>
                        </div>
                    </td>
                </tr>
